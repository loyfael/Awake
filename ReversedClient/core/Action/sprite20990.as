...
if (!dofus.graphics.gapi.ui.ChooseNickName)
{
    ...
    _loc1.click = function (oEvent)
    {
        switch (oEvent.target._name)
        {
            case "_btnOk":
            {
                ...
                com.ankamagames.tools.Logger.out(this._tiNickName.text, "dofus.graphics.gapi.ui.ChooseNickName::click", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/ChooseNickName.as", 146);
                if (_loc3.length > 2)
                {
                    com.ankamagames.tools.Logger.out("oua", "dofus.graphics.gapi.ui.ChooseNickName::click", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/ChooseNickName.as", 149);
    ...
    _loc1.onShortcut = function (sShortcut)
    {
        ...
        {
            com.ankamagames.tools.Logger.out(this, "dofus.graphics.gapi.ui.ChooseNickName::onShortcut", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/ChooseNickName.as", 190);
