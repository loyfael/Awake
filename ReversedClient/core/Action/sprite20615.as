...
if (!dofus.graphics.battlefield.DofusBattlefield)
{
    ...
    _loc1.onMapLoaded = function ()
    {
        ...
        com.ankamagames.tools.Logger.out("[wtf]onMapLoaded", "dofus.graphics.battlefield.DofusBattlefield::onMapLoaded", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/battlefield/DofusBattlefield.as", 81);
        ...
        if (this.api.datacenter.Game.isFight && this.api.kernel.OptionsManager.getOption("Grid"))
        {
    ...
    _loc1.onCellRelease = function (mcCell)
    {
        ...
        switch (this.api.datacenter.Game.interactionType)
        {
            ...
            case 2:
            {
                com.ankamagames.tools.Logger.out("WG Lancement d\'un sort avec cible", "dofus.graphics.battlefield.DofusBattlefield::onCellRelease", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/battlefield/DofusBattlefield.as", 330);
                if (this.api.datacenter.Player.currentUseObject != null && this.api.datacenter.Basics.gfx_canLaunch == true)
                {
                    ...
                    if (this.api.datacenter.Player.currentUseObject.boundObjectId == null)
                    {
                        _loc7.GameActionsManager.transmittingOther(300, [this.api.datacenter.Player.currentUseObject.ID, mcCell.num]);
                    }
                    else
                    {
                        _loc7.GameActionsManager.transmittingOther(300, [this.api.datacenter.Player.currentUseObject.boundObjectId, mcCell.num, 1]);
                    } // end else if
            ...
            case 5:
            {
                com.ankamagames.tools.Logger.out("WG Lancement d\'un objet avec cible", "dofus.graphics.battlefield.DofusBattlefield::onCellRelease", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/battlefield/DofusBattlefield.as", 403);
                if (this.api.datacenter.Player.currentUseObject != null && this.api.datacenter.Basics.gfx_canLaunch == true)
                {
    ...
    _loc1.onSpriteRelease = function (mcSprite)
    {
        ...
        switch (this.api.datacenter.Game.interactionType)
        {
            case 5:
            {
                if (!this.api.datacenter.Player.currentUseObject.castSpell)
                {
                    if (this.api.datacenter.Player.currentUseObject != null && this.api.datacenter.Basics.gfx_canLaunch == true)
                    {
            ...
            default:
            {
                ...
                else if (_loc3 instanceof dofus.datacenter.Character || _loc3 instanceof dofus.datacenter.Mutant && _loc3.showIsPlayer)
                {
                    ...
                    if (!_loc3.isInDungeonTeam())
                    {
                        if (_loc3.id == this.api.datacenter.Player.ID)
                        {
                            var _loc7 = _global.API.ui.getUIComponent("Banner");
                            if (_loc7 == undefined)
                            {
                                return;
                            } // end if
                        ...
                        else
                        {
                            ...
                            com.ankamagames.tools.Logger.out("showPlayerPopupMenu called from DofusBattlefield.as:675", "dofus.graphics.battlefield.DofusBattlefield::onSpriteRelease", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/battlefield/DofusBattlefield.as", 726);
                        } // end else if
                    }
                    else
                    {
                        if (!this.api.datacenter.Player.canChallenge)
                        {
                            com.ankamagames.tools.Logger.out("WG api.datacenter.Player.canChallenge == false. On ne peut pas rejoindre", "dofus.graphics.battlefield.DofusBattlefield::onSpriteRelease", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/battlefield/DofusBattlefield.as", 735);
                            break;
                        } // end if
                        this.api.network.Dungeon.join(_loc3.id, _loc3.DungeonTeam);
                    } // end else if
                }
                else if (_loc3 instanceof dofus.datacenter.NonPlayableCharacter)
                {
                    ...
                    var _loc8 = _loc3.actions;
                    if (_loc8 != undefined && _loc8.length != 0)
                    {
                        var _loc9 = this.api.ui.createPopupMenu();
                        var _loc10 = _loc8.length;
                        if (_loc8.length == 1)
                        {
                            var _loc11 = _loc8[0].action;
                            _loc11.method.apply(_loc11.object, _loc11.params);
                        }
                        else
                        {
                            while (_loc10-- > 0)
                            {
                                var _loc12 = _loc8[_loc10].action;
                                _loc9.addItem(_loc8[_loc10].name, _loc12.object, _loc12.method, _loc12.params);
                            } // end while
                ...
                {
                    var _loc13 = this.api.datacenter.Player.data.alignment.index;
                    var _loc14 = _loc3.alignment.index;
                    var _loc15 = _loc3.enemyTeam.alignment.index;
                    var _loc16 = _loc3.challenge.fightType;
                    var _loc17 = false;
                    switch (_loc16)
                    {
                        case 0:
                        {
                            switch (_loc3.type)
                            {
                                ...
                                case 2:
                                {
                                    _loc17 = this.api.datacenter.Player.canChallenge && (!this.api.datacenter.Player.isMutant || this.api.datacenter.Player.canAttackDungeonMonstersWhenMutant);
                                    break;
                                } 
                            } // End of switch
                            break;
                        ...
                        case 2:
                        {
                            switch (_loc3.type)
                            {
                                ...
                                case 1:
                                {
                                    if (_loc13 == _loc14)
                                    {
                                        _loc17 = !this.api.datacenter.Player.isMutant;
                                    }
                                    else
                                    {
                                        _loc17 = this.api.lang.getAlignmentCanJoin(_loc13, _loc14) && (this.api.lang.getAlignmentCanAttack(_loc13, _loc15) && !this.api.datacenter.Player.isMutant);
                                    } // end else if
                                    break;
                                } 
                            } // End of switch
                        ...
                        case 3:
                        {
                            switch (_loc3.type)
                            {
                                case 0:
                                {
                                    _loc17 = !this.api.datacenter.Player.isMutant || this.api.datacenter.Player.canAttackDungeonMonstersWhenMutant;
                                    break;
                                } 
                                case 1:
                                {
                        ...
                        case 5:
                        {
                            switch (_loc3.type)
                            {
                                case 0:
                                {
                                    _loc17 = !this.api.datacenter.Player.isMutant && !this.api.datacenter.Player.cantInteractWithTaxCollector;
                                    break;
                                } 
                                case 3:
                                {
                        ...
                        case 6:
                        {
                            switch (_loc3.type)
                            {
                                ...
                                case 2:
                                {
                                    _loc17 = this.api.datacenter.Player.isMutant && !this.api.datacenter.Player.canAttackDungeonMonstersWhenMutant == true;
                                    break;
                                } 
                            } // End of switch
                            break;
                    ...
                    if (_loc17)
                    {
                        var _loc18 = this.api.ui.createPopupMenu();
                        var _loc19 = this.api.lang.getMapMaxTeam(this.api.datacenter.Map.id);
                        var _loc20 = this.api.lang.getMapMaxChallenge(this.api.datacenter.Map.id);
                        if (_loc3.challenge.count >= _loc20)
                        {
                            _loc18.addItem(this.api.lang.getText("CHALENGE_FULL"));
                        }
                        else if (_loc3.count >= _loc19)
                        {
                            _loc18.addItem(this.api.lang.getText("TEAM_FULL"));
                        }
                        ...
                        {
                            _loc18.addItem(this.api.lang.getText("JOIN_SMALL"), this.api.network.GameActions, this.api.network.GameActions.joinChallenge, [_loc3.challenge.id, _loc3.id]);
                        } // end else if
                        _loc18.show(_root._xmouse, _root._ymouse);
                    } // end if
                }
                else if (_loc3 instanceof dofus.datacenter.ParkMount)
                {
                    ...
                    {
                        var _loc21 = this.api.ui.createPopupMenu();
                        _loc21.addStaticItem(this.api.lang.getText("MOUNT_OF", [_loc3.ownerName]));
                        _loc21.addItem(this.api.lang.getText("VIEW_MOUNT_DETAILS"), this.api.network.Mount, this.api.network.Mount.parkMountData, [_loc3.id]);
                        _loc21.show(_root._xmouse, _root._ymouse);
                    } // end if
                }
                else if (_loc3 instanceof dofus.datacenter.Creature)
                {
                    var _loc22 = this.mapHandler.getCellData(_loc3.cellNum).mc;
                    this.onCellRelease(_loc22);
                }
                ...
                else if (_loc3 instanceof dofus.datacenter.OfflineCharacter)
                {
                    if (!this.api.datacenter.Player.isMutant || this.api.datacenter.Player.canAttackDungeonMonstersWhenMutant)
                    {
                        ...
                        var _loc24 = this.api.ui.createPopupMenu();
                        _loc24.addStaticItem(this.api.lang.getText("SHOP") + " " + this.api.lang.getText("OF") + " " + _loc3.name);
                        _loc24.addItem(this.api.lang.getText("BUY"), this.api.kernel.GameManager, this.api.kernel.GameManager.startExchange, [4, _loc3.id, _loc3.cellNum]);
                        if (this.api.datacenter.Player.isAtHome(this.api.datacenter.Map.id))
                        {
                            _loc24.addItem(this.api.lang.getText("KICKOFF"), this.api.network.Basics, this.api.network.Basics.kick, [_loc3.cellNum]);
                        } // end if
                        _loc24.show(_root._xmouse, _root._ymouse);
                    } // end if
                }
                else if (_loc3 instanceof dofus.datacenter.TaxCollector)
                {
                    if (!this.api.datacenter.Player.isMutant)
                    {
                        ...
                        if (this.api.datacenter.Game.isFight)
                        {
                            var _loc25 = this.mapHandler.getCellData(_loc3.cellNum).mc;
                            this.onCellRelease(_loc25);
                        }
                        else
                        {
                            var _loc26 = this.api.datacenter.Player.guildInfos.playerRights;
                            var _loc27 = _loc3.guildName == this.api.datacenter.Player.guildInfos.name;
                            var _loc28 = _loc27 && _loc26.canHireTaxCollector;
                            var _loc29 = this.api.ui.createPopupMenu();
                            _loc29.addItem(this.api.lang.getText("SPEAK"), this.api.network.Dialog, this.api.network.Dialog.create, [_loc4]);
                            _loc29.addItem(this.api.lang.getText("COLLECT_TAX"), this.api.kernel.GameManager, this.api.kernel.GameManager.startExchange, [8, _loc4], _loc27);
                            _loc29.addItem(this.api.lang.getText("ATTACK"), this.api.network.GameActions, this.api.network.GameActions.attackTaxCollector, [[_loc4]], !_loc27);
                            _loc29.addItem(this.api.lang.getText("REMOVE"), this.api.kernel.GameManager, this.api.kernel.GameManager.askRemoveTaxCollector, [[_loc4]], _loc28);
                            _loc29.show(_root._xmouse, _root._ymouse);
                        } // end if
                    } // end else if
                }
                else if (_loc3 instanceof dofus.datacenter.PrismSprite)
                {
                    if (!this.api.datacenter.Player.isMutant)
                    {
                        if (this.api.datacenter.Game.isFight)
                        {
                            var _loc30 = this.mapHandler.getCellData(_loc3.cellNum).mc;
                            this.onCellRelease(_loc30);
                        }
                        else
                        {
                            var _loc31 = this.api.datacenter.Player.alignment.compareTo(_loc3.alignment) == 0;
                            var _loc32 = this.api.ui.createPopupMenu();
                            _loc32.addItem(this.api.lang.getText("USE_WORD"), this.api.network.GameActions, this.api.network.GameActions.usePrism, [[_loc4]], _loc31);
                            _loc32.addItem(this.api.lang.getText("ATTACK"), this.api.network.GameActions, this.api.network.GameActions.attackPrism, [[_loc4]], !_loc31);
                            _loc32.show(_root._xmouse, _root._ymouse);
                        } // end else if
                    } // end else if
                } // end else if
                break;
    ...
    _loc1.onSpriteRollOver = function (mcSprite)
    {
        ...
        if (_loc5 instanceof dofus.datacenter.Mutant && _loc5.showIsPlayer)
        {
            ...
            else if (this.api.datacenter.Game.isFight && dofus.Constants.WG_ROLLOVERSPRITE_SHOWS_LP_IN_FIGHT)
            {
                _loc9 = " (" + _loc5.LP + ")";
            }
            else
        ...
        else if (_loc5 instanceof dofus.datacenter.Character)
        {
            ...
            {
                _loc9 = "";
                this.addSpriteOverHeadItem(_loc5.id, "text", dofus.graphics.battlefield.GuildOverHead, [_loc5.guildName, _loc5.guildLevel, _loc5.name, _loc5.emblem, _loc3, _loc4, _loc5.pvpGain, _loc7], undefined, true);
            } // end if
        }
    ...
    _loc1.onObjectRelease = function (mcObject)
    {
        ...
        if (!_global.isNaN(_loc5) && (this.api.datacenter.Player.canUseInteractiveObjects && this.api.datacenter.Game.interactionType != 5))
        {
            ...
            var _loc10 = _loc8.sk;
            var _loc11 = _loc8.t;
            com.ankamagames.tools.Logger.out("WG DofusBattlefield.as:1448 nObject2Num = " + _loc5 + ", sObject2Name = " + _loc9 + ", aObject2Skills = " + _loc10 + ", aObject2Skills[0] = " + _loc10[0] + ", nObject2Type = " + _loc11, "dofus.graphics.battlefield.DofusBattlefield::onObjectRelease", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/battlefield/DofusBattlefield.as", 1454);
            switch (_loc11)
            {
                case 2:
                case 23:
                {
                    this.api.kernel.GameManager.useRessourceFromHere(_loc4.num, _loc10[0]);
                    break;
                } 
                case 24:
                case 16:
                ...
                case 3:
                {
                    this.api.kernel.GameManager.useRessource(_loc4, _loc4.num, _loc10[0]);
                    break;
                } 
                case 22:
                {
                    this.api.ui.loadUIComponent("SpeakingSign", "SpeakingSign", {artworkId: _loc5, mapId: this.api.datacenter.Map.id, cellId: _loc4.num});
                    break;
                } 
                case 1:
                case 4:
