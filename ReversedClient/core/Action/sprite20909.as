...
if (!dofus.graphics.gapi.ui.Storage)
{
    ...
    _loc1.dblClickItem = function (oEvent)
    {
        ...
        if (Key.isDown(Key.ALT) && false)
        {
            ...
            com.ankamagames.tools.Logger.out(oEvent.target._name, "dofus.graphics.gapi.ui.Storage::dblClickItem", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Storage.as", 231);
