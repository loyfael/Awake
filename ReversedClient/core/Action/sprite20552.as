...
if (!dofus.graphics.gapi.ui.MainMenu)
{
    ...
    _loc1.init = function ()
    {
        ...
        this._btnSubscribe._visible = !dofus.Constants.WG_DISABLE_SUBCRIBE_SYSTEM;
        this._btnHelp._visible = false;
        this._btnOptions._x = this._btnHelp._x;
        this._mcBackground._x = 760;
    };
    ...
    _loc1.setQuitButtonStatus = function ()
    {
        ...
        else if (!this.api.datacenter.Player.subscriber && (!this.api.datacenter.Basics.aks_is_free_community && !dofus.Constants.WG_DISABLE_SUBCRIBE_SYSTEM))
        {
            this._mcBackground._x = 730;
            this._bBackgroundMoved = true;
    ...
    {
        if (dofus.Constants.BETAVERSION == 0 && (!this.api.datacenter.Player.subscriber && (!this.api.datacenter.Basics.aks_is_free_community && !dofus.Constants.WG_DISABLE_SUBCRIBE_SYSTEM)))
        {
        ...
        else if (!this._btnBugs._visible)
        {
            if (this._bBackgroundMoved)
            {
                this._mcBackground._x = 744.300000;
