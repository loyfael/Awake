...
if (!dofus.SaveTheWorld)
{
    ...
    {
        com.ankamagames.tools.Logger.out("[?!!] Saving the world : " + ++this.nCount + "/" + this.nTotal + " (" + Math.round(this.nCount / this.nTotal * 100) + "%)", "dofus.SaveTheWorld::traceProgress", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/SaveTheWorld.as", 139);
    ...
    {
        com.ankamagames.tools.Logger.out("Socket connexion result : " + (success ? ("OK! :)))))") : ("Failed! :((((((")), "dofus.SaveTheWorld::onConnect", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/SaveTheWorld.as", 177);
        if (success)
        {
            this.runInnerQueue();
        } // end if
    ...
    {
        com.ankamagames.tools.Logger.out("Socket closed! :((((", "dofus.SaveTheWorld::onClose", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/SaveTheWorld.as", 184);
        dofus.SaveTheWorld.queue = new Array();
    };
