...
if (!dofus.graphics.battlefield.AbstractTextOverHead)
{
    ...
    {
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcTxtBackground, -nWidth / 2, 0, nWidth, nHeight, 3, nColor, dofus.graphics.battlefield.AbstractTextOverHead.BACKGROUND_ALPHA);
    };
