...
if (!dofus.graphics.gapi.ui.ChooseCharacter)
{
    ...
    _loc1.init = function ()
    {
        ...
        if (_global.CONFIG.isExpo)
        {
            this._btnCreate.enable = false;
        } // end if
    };
    ...
    _loc1.addListeners = function ()
    {
        ...
        var ref = this;
        this._btnPlay.onPress = function ()
        {
            ref.click({target: this});
        };
        if (!_global.CONFIG.isExpo)
        {
            this._btnCreate.onPress = function ()
            {
                ref.click({target: this});
            };
        } // end if
    ...
    _loc1.updateCharactersList = function ()
    {
        ...
        while (++_loc2, _loc2 < dofus.Constants.WG_MAX_CHARACTERS_PER_ACCOUNT)
        {
    ...
    _loc1.initData = function ()
    {
        ...
        this._btnArrowLeft._visible = this._btnArrowRight._visible = this._aSpriteList.length > dofus.Constants.WG_MAX_CHARACTERS_PER_ACCOUNT;
        ...
        this._btnArrowRight.onRelease = function ()
        {
            ...
            this._parent._btnArrowRight.gotoAndStop("on");
            ++this._parent._nCharacterStartIndex;
            if (this._parent._nCharacterStartIndex >= this._parent._aSpriteList.length - dofus.Constants.WG_MAX_CHARACTERS_PER_ACCOUNT)
            {
                this._parent._nCharacterStartIndex = this._parent._aSpriteList.length - dofus.Constants.WG_MAX_CHARACTERS_PER_ACCOUNT;
                this.gotoAndStop("off");
            } // end if
            this._parent.updateCharactersList();
        };
    ...
    _loc1.initTexts = function ()
    {
        ...
        this._btnPlay._lblLabel.text = this.api.lang.getText("MENU_PLAY");
        this._btnCreate._lblLabel.text = this.api.lang.getText("CREATE_CHARACTER");
        ...
        this._lblServer.text = this.api.lang.getText("CURRENT_SERVER", [""]);
    };
    _loc1.select = function (oEvent)
    {
        var _loc3 = oEvent.target.params.index;
        this["_cciSprite" + this._nSelectedIndex].unselect();
    ...
    _loc1.click = function (oEvent)
    {
        switch (oEvent.target._name)
        {
            case "_btnPlay":
            {
                ...
                {
                    this.api.datacenter.Basics.hasSelectedCharacter = true;
            ...
            case "_btnCreate":
            {
                if (this._nCharacterCount >= dofus.Constants.WG_MAX_CHARACTERS_PER_ACCOUNT)
                {
                    this.api.kernel.showMessage(undefined, this.api.lang.getText("TOO_MUCH_CHARACTER", [dofus.Constants.WG_MAX_CHARACTERS_PER_ACCOUNT]), "ERROR_BOX");
                }
                else
                {
