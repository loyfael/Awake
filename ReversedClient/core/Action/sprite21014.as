...
// [Initial MovieClip Action of sprite 21014]
#initclip 23
if (!dofus.datacenter.QuestObjective)
{
    ...
    _loc1.__get__description = function ()
    {
        ...
        com.ankamagames.tools.Logger.out("[wtf] nType = " + _loc3, "dofus.datacenter.QuestObjective::description", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/datacenter/QuestObjective.as", 37);
        switch (_loc3)
        {
            case 0:
            case 4:
