...
// [Initial MovieClip Action of sprite 20997]
#initclip 6
    ...
    _loc1.click = function (oEvent)
    {
        switch (oEvent.target._name)
        {
            ...
            case "_btnAction":
            {
                ...
                if (this._bUseButton && (this._oItem.canUse && !dofus.Constants.WG))
                {
                ...
                if (this._bTargetButton && (this._oItem.canTarget && !dofus.Constants.WG))
                {
