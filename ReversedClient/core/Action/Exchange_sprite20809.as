...
if (!dofus.aks.Exchange)
{
    ...
    _loc1.onLeave = function (bSuccess, sExtraData)
    {
        ...
        this.api.ui.unloadUIComponent("Fashion");
    ...
    _loc1.onCreate = function (bSuccess, sExtraData)
    {
        ...
        switch (_loc5)
        {
            ...
            case 4:
            {
                ...
                _loc9[4] = _loc8.color4 == undefined ? (-1) : (_loc8.color4);
                _loc9[5] = _loc8.color5 == undefined ? (-1) : (_loc8.color5);
                if (_loc5 == 0)
                {
            ...
            case 3:
            {
                ...
                if (_loc5 == 3)
                {
                    ...
                    {
                        com.ankamagames.tools.Logger.out("WG ! Exchange.onCreate " + _loc11, "dofus.aks.Exchange::onCreate", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Exchange.as", 522);
                        if (_loc11 == 6)
                        {
                            this.api.ui.loadUIComponent("Fashion", "Fashion");
                        }
                        else
                        {
    ...
    _loc1.onCrafterListChanged = function (sExtraData)
    {
        ...
        if (_loc3)
        {
            ...
            this.api.kernel.CharactersManager.setSpriteAccessories((ank.battlefield.datacenter.Sprite)(_loc18), _loc16);
            if (_loc8.index != -1)
            {
