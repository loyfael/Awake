...
if (!dofus.utils.DofusConfiguration)
{
    ...
    _loc1.__set__autoLogin = function (autologin)
    {
        this._bIsAutoLogin = autologin;
        //return (this.autoLogin());
    };
    _loc1.__get__autoLogin = function ()
    {
        return (this._bIsAutoLogin);
    };
    _loc1.__set__login = function (login)
    {
        this._sLogin = login;
        //return (this.login());
    };
    ...
    _loc1.__set__pass = function (pass)
    {
        this._sPass = pass;
        //return (this.pass());
    };
    _loc1.__get__pass = function ()
    {
        return (this._sPass);
    };
    ...
    _loc1.addProperty("autoLogin", _loc1.__get__autoLogin, _loc1.__set__autoLogin);
    _loc1.addProperty("streamingMethod", _loc1.__get__streamingMethod, _loc1.__set__streamingMethod);
    _loc1.addProperty("pass", _loc1.__get__pass, _loc1.__set__pass);
