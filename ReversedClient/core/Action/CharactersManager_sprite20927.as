...
if (!dofus.managers.CharactersManager)
{
    ...
    _loc1.setSpriteAccessories = function (oSprite, sAccessories, base10)
    {
        ...
        {
            var accessoriesListParsed = new Array();
            var accessoriesList = sAccessories.split(",");
            var i = 0;
            
            while (++i, i < accessoriesList.length)
            {
                if (accessoriesList[i].indexOf("~") != -1)
                {
                    var tildeSplitted = accessoriesList[i].split("~");
                    if (base10)
                    {
                        var _loc8 = _global.parseInt(tildeSplitted[0], 10);
                    }
                    else
                    {
                        _loc8 = _global.parseInt(tildeSplitted[0], 16);
                    } // end else if
                    var _loc10 = _global.parseInt(tildeSplitted[1]);
                    var _loc9 = _global.parseInt(tildeSplitted[2]) - 1;
                }
                else
                {
                    if (base10)
                    {
                        _loc8 = _global.parseInt(accessoriesList[i], 10);
                    }
                    else
                    {
                        _loc8 = _global.parseInt(accessoriesList[i], 16);
                    } // end else if
                    _loc10 = undefined;
                    _loc9 = undefined;
                } // end else if
                com.ankamagames.tools.Logger.out("WG On ajoute l\'accesoire " + _loc8 + " au mob " + oSprite + " " + oSprite.id + " à l\'emplacement " + i, "dofus.managers.CharactersManager::setSpriteAccessories", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/CharactersManager.as", 828);
                if (!_global.isNaN(_loc8) && _loc8 > -1)
                {
                    var accessoryObj = new dofus.datacenter.Accessory(_loc8, _loc10, _loc9);
                    accessoriesListParsed[i] = accessoryObj;
                    switch (i)
                    {
                        case 3:
                        {
                            var _loc13 = new dofus.datacenter.Accessory(accessoriesListParsed[3].unicId, 100, undefined);
                            var _loc14 = new dofus.datacenter.Accessory(accessoriesListParsed[3].unicId, 101, undefined);
                            var _loc15 = new dofus.datacenter.Accessory(accessoriesListParsed[3].unicId, 102, undefined);
                            var _loc16 = new dofus.datacenter.Accessory(accessoriesListParsed[3].unicId, 103, undefined);
                            var _loc17 = new dofus.datacenter.Accessory(accessoriesListParsed[3].unicId, 104, undefined);
                            var _loc18 = new dofus.datacenter.Accessory(accessoriesListParsed[3].unicId, 105, undefined);
                            _loc13.gfxID = accessoriesListParsed[3].gfxID;
                            _loc14.gfxID = accessoriesListParsed[3].gfxID;
                            _loc15.gfxID = accessoriesListParsed[3].gfxID;
                            _loc16.gfxID = accessoriesListParsed[3].gfxID;
                            _loc17.gfxID = accessoriesListParsed[3].gfxID;
                            _loc18.gfxID = accessoriesListParsed[3].gfxID;
                            accessoriesListParsed[10] = _loc13;
                            accessoriesListParsed[11] = _loc14;
                            accessoriesListParsed[12] = _loc15;
                            accessoriesListParsed[13] = _loc16;
                            accessoriesListParsed[14] = _loc17;
                            accessoriesListParsed[15] = _loc18;
                            break;
                        } 
                        case 4:
                        {
                            var _loc19 = new dofus.datacenter.Accessory(accessoriesListParsed[4].unicId, 106, undefined);
                            var _loc20 = new dofus.datacenter.Accessory(accessoriesListParsed[4].unicId, 107, undefined);
                            var _loc21 = new dofus.datacenter.Accessory(accessoriesListParsed[4].unicId, 108, undefined);
                            var _loc22 = new dofus.datacenter.Accessory(accessoriesListParsed[4].unicId, 109, undefined);
                            var _loc23 = new dofus.datacenter.Accessory(accessoriesListParsed[4].unicId, 110, undefined);
                            _loc19.gfxID = accessoriesListParsed[4].gfxID;
                            _loc20.gfxID = accessoriesListParsed[4].gfxID;
                            _loc21.gfxID = accessoriesListParsed[4].gfxID;
                            _loc22.gfxID = accessoriesListParsed[4].gfxID;
                            _loc23.gfxID = accessoriesListParsed[4].gfxID;
                            accessoriesListParsed[16] = _loc19;
                            accessoriesListParsed[17] = _loc20;
                            accessoriesListParsed[18] = _loc21;
                            accessoriesListParsed[19] = _loc22;
                            accessoriesListParsed[20] = _loc23;
                            break;
                        } 
                        case 5:
                        {
                            var _loc24 = new dofus.datacenter.Accessory(accessoriesListParsed[5].unicId, 99, undefined);
                            _loc24.gfxID = accessoriesListParsed[5].gfxID;
                            accessoriesListParsed[9] = _loc24;
                        } 
                        default:
                        {
                            break;
            ...
            if (dofus.Constants.WG_FORCE_TAIL)
            {
                var _loc25 = new dofus.datacenter.Accessory(accessoriesListParsed[1].unicId, 17, undefined);
                _loc25.gfxID = accessoriesListParsed[1].gfxID;
                accessoriesListParsed[2] = _loc25;
            } // end if
            oSprite.accessories = accessoriesListParsed;
            this.api.gfx.setForcedSpriteAnim(oSprite.id, "static");
        } // end if
    };
