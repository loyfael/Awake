...
if (!dofus.graphics.gapi.controls.JobOptionsViewer)
{
    ...
    _loc1.optionsChanged = function (oEvent)
    {
        if (this._oJob != undefined && this._btnNotFree.selected != undefined)
        {
            ...
            com.ankamagames.tools.Logger.out("Test " + this._btnNotFree.selected, "dofus.graphics.gapi.controls.JobOptionsViewer::optionsChanged", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/controls/JobOptionsViewer.as", 233);
