...
if (!dofus.datacenter.GuildInfos)
{
    ...
    _loc1.setGeneralInfos = function (bValid, nLevel, nXPMin, nXP, nXPMax, nPoints)
    {
        this._bValid = bValid;
        this._nLevel = nLevel;
        this._nXPMin = nXPMin;
    ...
    _loc1.setMembers = function ()
    {
        ...
        _loc2.members.sortOn("rankOrder", Array.NUMERIC);
        var _loc3 = this.api.ui.getUIComponent("Friends");
        if (_loc3 != undefined)
        {
            _loc3.clanList = _loc2.members;
        } // end if
    };
