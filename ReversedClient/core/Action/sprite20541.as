...
if (!dofus.managers.SpellsManager)
{
    ...
    _loc1.checkCanLaunchSpellReturnObject = function (nSpellID, nSpriteOnID)
    {
        ...
        if (dofus.Constants.WG_DISABLE_SPELL_OUT_OF_TURN && !this.api.datacenter.Player.isCurrentPlayer)
        {
            return ({can: false, type: "NOT_PLAYER_TURN"});
        } // end if
        ...
        if (_loc9.needStates)
        {
            ...
            com.ankamagames.tools.Logger.out("WG On a un sort qui interdit " + _loc12 + " et oblige " + _loc11, "dofus.managers.SpellsManager::checkCanLaunchSpellReturnObject", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/SpellsManager.as", 192);
            var _loc13 = 0;
            ...
            while (++_loc13, _loc13 < _loc11.length)
            {
                if (!this.api.datacenter.Player.data.isInState(_loc11[_loc13]))
                {
                    ...
                    com.ankamagames.tools.Logger.out("On a pas l\'état necessaire " + _loc11[_loc13], "dofus.managers.SpellsManager::checkCanLaunchSpellReturnObject", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/SpellsManager.as", 198);
                    break;
                } // end if
            } // end while
            var _loc14 = 0;
            ...
            while (++_loc14, _loc14 < _loc12.length)
            {
                if (this.api.datacenter.Player.data.isInState(_loc12[_loc14]))
                {
                    ...
                    com.ankamagames.tools.Logger.out("On a l\'état interdit " + _loc12[_loc14], "dofus.managers.SpellsManager::checkCanLaunchSpellReturnObject", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/SpellsManager.as", 207);
                    break;
                } // end if
            } // end while
        } // end if
