...
if (!dofus.graphics.gapi.ui.SecureCraft)
{
    ...
    _loc1.click = function (oEvent)
    {
        ...
        if (oEvent.target == this._btnValidate)
        {
            ...
            com.ankamagames.tools.Logger.out("nItemId : " + _loc3, "dofus.graphics.gapi.ui.SecureCraft::click", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/SecureCraft.as", 1252);
            com.ankamagames.tools.Logger.out("AskForWrongCraft : " + this.api.kernel.OptionsManager.getOption("AskForWrongCraft"), "dofus.graphics.gapi.ui.SecureCraft::click", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/SecureCraft.as", 1253);
            com.ankamagames.tools.Logger.out("isNotForgemagus() : " + this.isNotForgemagus(), "dofus.graphics.gapi.ui.SecureCraft::click", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/SecureCraft.as", 1254);
