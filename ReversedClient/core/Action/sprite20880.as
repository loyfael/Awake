...
if (!ank.gapi.controls.VolumeSlider)
{
    ...
    _loc1.createMarkers = function ()
    {
        ...
        while (++_loc2, _loc2 < this._nMarkerCount)
        {
            ...
            ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4, 0, 0, 1, 1, 0, 16711935, 0);
            _loc4.index = _loc2;
            ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3, this.getStyle().offcolor);
    ...
    _loc1.setValueByIndex = function (nIndex)
    {
        ...
        {
            ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcMarkers["mcMarker" + _loc5], _loc3);
        } // end while
        var _loc6 = nIndex + 1;
        
        while (++_loc6, _loc6 < this._nMarkerCount)
        {
            ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcMarkers["mcMarker" + _loc6], _loc4);
        } // end while
    };
    ...
    _loc1._nMarkerWidthRatio = 0.700000;
