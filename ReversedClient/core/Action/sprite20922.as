...
if (!ank.gapi.controls.button.ButtonBackground)
{
    ...
    _loc1.setStyleColor = function (oStyle, sSuffixe)
    {
        ...
        for (var k in _loc4)
        {
            ...
            if (_loc6 != undefined)
            {
                ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc4[k], _loc6);
            } // end if
        } // end of for...in
        ...
        for (var k in _loc4)
        {
            ...
            if (_loc8 != undefined)
            {
                ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc4[k], _loc8);
            } // end if
        } // end of for...in
        _loc4 = this.right_mc;
        for (var k in _loc4)
        {
            ...
            if (_loc10 != undefined)
            {
                ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc4[k], _loc10);
            } // end if
        } // end of for...in
    };
