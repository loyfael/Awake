...
if (!dofus.datacenter.QuestStep)
{
    ...
    _loc1.__get__rewards = function ()
    {
        ...
        {
            com.ankamagames.tools.Logger.out("WG QuestStep :rewards", "dofus.datacenter.QuestStep::rewards", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/datacenter/QuestStep.as", 153);
            var _loc20 = _loc3[6];
            var _loc21 = 0;
            
            while (++_loc21, _loc21 < _loc20.length)
            {
                var _loc22 = Number(_loc20[_loc21]);
                _loc2.push({label: this.api.lang.getTitle(_loc22).t});
            } // end while
        } // end if
        return (_loc2);
    };
