...
if (!dofus.graphics.gapi.ui.PlayerInfos)
{
    ...
    _loc1.initData = function ()
    {
        if (this._oData != undefined)
        {
            ...
            com.ankamagames.tools.Logger.out(this._oData.states, "dofus.graphics.gapi.ui.PlayerInfos::initData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/PlayerInfos.as", 92);
        } // end if
    };
    _loc1.quit = function ()
    {
