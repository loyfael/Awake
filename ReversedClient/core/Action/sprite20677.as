...
if (!ank.gapi.controls.PopupMenu)
{
    ...
    _loc1.draw = function ()
    {
        ...
        var _loc3 = _loc2.borderalpha != undefined ? (_loc2.borderalpha) : (100);
        var _loc4 = _loc2.backgroundalpha != undefined ? (_loc2.backgroundalpha) : (100);
        var _loc5 = _loc2.foregroundalpha != undefined ? (_loc2.foregroundalpha) : (100);
        var _loc6 = _loc2.foregroundrotation != undefined ? (_loc2.foregroundrotation) : (100);
        this._mcBorder.clear();
        this._mcBackground.clear();
        this._mcForeground.clear();
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcBorder, 0, 0, 1, 1, 0, _loc2.bordercolor, _loc3);
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcBackground, 0, 0, 1, 1, 0, _loc2.backgroundcolor, _loc4);
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcForeground, 0, 0, 1, 1, 0, _loc2.foregroundcolor, _loc5, _loc6);
    };
    _loc1.drawItem = function (i, index, nY)
    {
        ...
        if (i.bEnabled)
        {
            ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4.bg, 0, 0, 1, _loc6, 0, this.getStyle().itembgcolor);
            ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4.bg, 0, 0, 1, 1, 0, 16777215);
            ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4.bg, 0, _loc6 - 1, 1, 1, 0, 16777215);
            _loc4.bg._alpha = this.getStyle().itembgalpha != undefined ? (this.getStyle().itembgalpha) : (100);
            ...
            {
                this._alpha = this._parent._parent._parent.getStyle().itemoveralpha != undefined ? (this._parent._parent._parent.getStyle().itemoveralpha) : (100);
            ...
            {
                this._alpha = this._parent._parent._parent.getStyle().itembgalpha != undefined ? (this._parent._parent._parent.getStyle().itembgalpha) : (100);
                var _loc2 = new Color(this);
        ...
        else
        {
            if (i.bStatic)
            {
                ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4.bg, 0, 0, 1, _loc6, 0, this.getStyle().itemstaticbgcolor, 100, this.getStyle().itemstaticbgrotation);
                ank.gapi.core.UIBasicComponent.drawRoundRect(_loc4.bg, 0, _loc6 - 1, 1, 1, 0, 16777215);
                if (this.getStyle().titledecorationstyle != undefined)
                {
                    _loc4.createEmptyMovieClip("decor", 15);
                } // end if
            } // end if
    ...
    _loc1.arrangeItem = function (nIndex, nWidth)
    {
        ...
        if (_loc4.decor != undefined)
        {
            ank.gapi.core.UIBasicComponent.drawDecoration(_loc4.decor, ank.gapi.styles.StylesManager.getStyle(this.getStyle().titledecorationstyle), -2, 0, nWidth + 2, _loc4._height);
            _loc4.bg.decor._y = _loc4.decor._y - 1;
        } // end if
    };
