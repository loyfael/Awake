...
if (!dofus.aks.Aks)
{
    ...
    _loc1.initialize = function (oAPI)
    {
        ...
        this.Ladder = new dofus.aks.Ladder(this, oAPI);
        ...
        this.Achievements = new dofus.aks.Achievements(this, oAPI);
        ...
        this.Dungeon = new dofus.aks.Dungeon(this, oAPI);
        this.Ping = new Object();
        this.Lag = new Object();
        this.Deco = new Object();
        this.PVPBattle = new dofus.aks.PVPBattle(this, oAPI);
        this._bLag = false;
    ...
    {
        com.ankamagames.tools.Logger.out("connect " + sHost + ":" + nPort, "dofus.aks.Aks::connect", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 162);
    ...
    _loc1.send = function (sData, bWaiting, sWaitingMessage, bNoLimit, bNoCyphering)
    {
        ...
        {
            com.ankamagames.tools.Logger.out("SND " + sData, com.ankamagames.tools.Logger.NETWORK_OUT, "dofus.aks.Aks::send", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 257);
        } // end if
        if (!bNoCyphering)
        {
        ...
        {
            com.ankamagames.tools.Logger.out("SND (C) " + sData, com.ankamagames.tools.Logger.NETWORK_OUT, "dofus.aks.Aks::send", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 276);
        } // end if
    };
    ...
    _loc1.unprepareData = function (s)
    {
        ...
        if (_loc3 == undefined)
        {
            com.ankamagames.tools.Logger.out("[?!!] Le serveur a demandé une clé que je n\'ai pas...", "dofus.aks.Aks::unprepareData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 311);
            return (s);
        } // end if
        ...
        {
            com.ankamagames.tools.Logger.out("[?!!] Checksum invalide! (Reçu : " + s.substr(1, 1) + ", Calculé : " + dofus.aks.Aks.checksum(_loc5) + ")", "dofus.aks.Aks::unprepareData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 324);
            com.ankamagames.tools.Logger.out("[?!!] Données interpretées : " + _loc5, "dofus.aks.Aks::unprepareData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 325);
            return (s);
        } // end if
        return (_loc5);
    };
    _loc1.prepareData = function (s)
    {
        ...
        {
            com.ankamagames.tools.Logger.out("[?!!] La clé " + this._nCurrentKey + " définie en clé actuelle n\'existe pas dans le buffer...", "dofus.aks.Aks::prepareData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 341);
            return (s);
        } // end if
    ...
    {
        com.ankamagames.tools.Logger.out("Résultat de la Connection : " + bSuccess, "dofus.aks.Aks::onConnect", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 521);
    ...
    _loc1.onData = function (sData)
    {
        ...
        if (dofus.Constants.DEBUG && (dofus.Constants.DEBUG_DATAS && dofus.Constants.DEBUG_ENCRYPTION))
        {
            com.ankamagames.tools.Logger.out("RCV (C) " + sData, com.ankamagames.tools.Logger.NETWORK_IN, "dofus.aks.Aks::onData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 627);
        } // end if
        sData = this.unprepareData(sData);
        if (dofus.Constants.DEBUG && dofus.Constants.DEBUG_DATAS)
        {
            com.ankamagames.tools.Logger.out("RCV " + sData, com.ankamagames.tools.Logger.NETWORK_IN, "dofus.aks.Aks::onData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 633);
        } // end if
        if (this._isWaitingForData)
        {
            ...
            if (_loc3 > 100)
            {
                com.ankamagames.tools.Logger.out("[wtf] " + this._sDebug + " (since " + _loc3 + "ms)", "dofus.aks.Aks::onData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 642);
            } // end if
    ...
    {
        com.ankamagames.tools.Logger.out("------------ On a bien reçu l\'ack du serveur de jeu -------------", "dofus.aks.Aks::onHelloGameServer", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Aks.as", 825);
