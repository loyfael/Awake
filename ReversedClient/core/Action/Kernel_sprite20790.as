...
if (!dofus.Kernel)
{
    ...
    {
        super();
        com.ankamagames.tools.Logger.out("Kernel constructor " + oAPI, "dofus.Kernel::Kernel", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/Kernel.as", 52);
        this.initialize(oAPI);
        if (this.AudioManager == null)
        {
            dofus.sounds.AudioManager.initialize(_root.createEmptyMovieClip("SoundNest", 99999), oAPI.config.language, oAPI);
    ...
    _loc1.start = function ()
    {
        ...
        {
            com.ankamagames.tools.Logger.out("[?!!] Mode streaming activé (" + this.api.config.streamingMethod + ")!", "dofus.Kernel::start", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/Kernel.as", 182);
    ...
    _loc1.onInitAndLoginFinished = function ()
    {
        ...
        {
            com.ankamagames.tools.Logger.out("WG On a " + this.api.datacenter.Basics.characterToDeleteId, "dofus.Kernel::onInitAndLoginFinished", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/Kernel.as", 594);
            if (this.api.datacenter.Basics.characterToDeleteId && this.api.datacenter.Basics.characterToDeleteId != -1)
            {
                this.api.network.Account.getCharacterListForced();
                this.api.datacenter.Basics.characterToDeleteId = -1;
            }
            else
            {
                this.api.network.Account.getCharacterList();
            } // end else if
        } // end else if
    };
    ...
    _loc1.XTRA_LANG_FILES_LOADED = true;
} // end if
#endinitclip
