...
if (!ank.battlefield.utils.Pathfinding)
{
    ...
    }).pathFind = function (mapHandler, nCellBegin, nCellEnd, oParams)
    {
        ...
        if (_loc6)
        {
            ...
            var _loc14 = [1.500000, 1, 1.500000, 1, 1.500000, 1, 1.500000, 1];
        }
        else
        {
            _loc12 = 4;
            ...
            while (++_loc25, _loc25 < _loc12)
            {
                ...
                if (Math.abs(_loc15[_loc26].x - _loc15[_loc22.num].x) <= 53)
                {
                    ...
                    if (_loc30 && (_loc27.active && _loc29))
                    {
                        ...
                        var _loc32 = _loc22.v + _loc14[_loc25] + (_loc27.movement == 0 || _loc27.movement == 1 ? (1000 + (_loc25 % 2 == 0 ? (3) : (0))) : (0)) + (_loc27.movement == 1 && _loc24 ? (-1000) : ((_loc25 != _loc22.d ? (0.500000) : (0)) + (5 - _loc27.movement) / 3));
    ...
    }).checkView = function (mapHandler, cell1, cell2)
    {
        ...
        var _loc9 = _loc7.spriteOnID ? (1.500000) : (0);
        var _loc10 = _loc8.spriteOnID ? (1.500000) : (0);
        _loc9 = _loc9 + (_loc7.carriedSpriteOnId ? (1.500000) : (0));
        _loc10 = _loc10 + (_loc8.carriedSpriteOnId ? (1.500000) : (0));
        ...
        var _loc27 = _loc5.x + 0.500000 * _loc15;
        ...
        while (_loc27 = _loc27 + _loc15, _loc27 * _loc15 <= _loc19)
        {
            ...
            if (_loc16 > 0)
            {
                ...
                var _loc22 = Math.ceil(_loc25 - 0.500000);
            }
            else
            {
                _loc21 = Math.ceil(_loc25 - 0.500000);
        ...
        {
            if (!ank.battlefield.utils.Pathfinding.checkCellView(mapHandler, _loc27 - 0.500000 * _loc15, _loc26, false, _loc5, _loc6, _loc11, _loc12))
            {
                return (false);
            } // end if
        } // end while
        if (!ank.battlefield.utils.Pathfinding.checkCellView(mapHandler, _loc27 - 0.500000 * _loc15, _loc26 - _loc16, true, _loc5, _loc6, _loc11, _loc12))
        {
            return (false);
        } // end if
        return (true);
