...
if (!dofus.datacenter.LocalPlayer)
{
    ...
    {
        this._nXPLow = Number(low);
        this._nXP = Number(current);
        this._nXPHigh = Number(high);
        this.dispatchEvent({type: "xpChanged", value: this._nXP, low: this._nXPLow, high: this._nXPHigh});
    };
