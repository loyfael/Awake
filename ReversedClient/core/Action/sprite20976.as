...
if (!ank.gapi.controls.DataGrid)
{
    ...
    _loc1.arrange = function ()
    {
        ...
        while (++_loc3, _loc3 < this._aColumnsWidths.length)
        {
            ...
            if (this.getStyle().titlelabelxoffset != undefined)
            {
                _loc6._tText._x = this.getStyle().titlelabelxoffset;
            } // end if
            if (this.getStyle().titlelabelyoffset != undefined)
            {
                _loc6._tText._y = this.getStyle().titlelabelyoffset;
            } // end if
            _loc2 = _loc2 + _loc4;
        } // end while
    };
    _loc1.draw = function ()
    {
        ...
        this._mcTitle.clear();
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcTitle, 0, 0, this.__width, this._nTitleHeight, _loc2.titlecornerradius, _loc2.titlebgcolor, _loc2.titlebgalpha, _loc2.titlerotation);
        this._mcTitle._alpha = _loc2.titlebgcolor == -1 ? (0) : (100);
        if (_loc2.titledecorationstyle != undefined)
        {
            ank.gapi.core.UIBasicComponent.drawDecoration(this._mcTitle, ank.gapi.styles.StylesManager.getStyle(_loc2.titledecorationstyle), 0, 0, this.__width, this._nTitleHeight);
        } // end if
    };
