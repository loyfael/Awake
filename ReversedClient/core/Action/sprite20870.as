...
if (!dofus.graphics.gapi.ui.Gifts)
{
    ...
    _loc1.checkNextGift = function ()
    {
        ...
        {
            if (this.api.datacenter.Basics.hasSelectedCharacter)
            {
                com.ankamagames.tools.Logger.out("WG on sélectionne automatiquement un perso", "dofus.graphics.gapi.ui.Gifts::checkNextGift", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Gifts.as", 83);
            ...
            {
                com.ankamagames.tools.Logger.out("WG Gifts : checkNextGift : Dois y avoir un cas auquel on a pas pensé", "dofus.graphics.gapi.ui.Gifts::checkNextGift", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Gifts.as", 87);
            } // end else if
            this.unloadThis();
        } // end else if
    };
    ...
    _loc1.callClose = function ()
    {
        if (this.api.datacenter.Basics.hasSelectedCharacter)
        {
            com.ankamagames.tools.Logger.out("WG on sélectionne automatiquement un perso", "dofus.graphics.gapi.ui.Gifts::callClose", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Gifts.as", 115);
            this.api.datacenter.Basics.hasSelectedCharacter = false;
            this.api.network.Account.setCharacter(this.api.datacenter.Basics.selectedCharacter);
        }
        else
        {
            com.ankamagames.tools.Logger.out("WG Gifts : callClose : Dois y avoir un cas auquel on a pas pensé", "dofus.graphics.gapi.ui.Gifts::callClose", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Gifts.as", 119);
        } // end else if
        this.unloadThis();
    };
