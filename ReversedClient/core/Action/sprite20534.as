...
if (!ank.battlefield.mc.ExternalContainer)
{
    ...
    {
        for (var object in this.InteractionCell)
        {
            if (typeof(this.InteractionCell[object]) == "movieclip")
            {
                this.InteractionCell[object].removeMovieClip();
            } // end if
        } // end of for...in
        this.InteractionCell.clear();
