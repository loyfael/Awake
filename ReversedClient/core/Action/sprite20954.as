...
if (!dofus.datacenter.Item)
{
    ...
    _loc1.__get__simpleDescription = function ()
    {
        return (ank.utils.PatternDecoder.getDescription(this.api.lang.fetchString(this._oUnicInfos.d), this.api.lang.getItemUnicStringText()));
    };
    ...
    _loc1.__get__castSpell = function ()
    {
        com.ankamagames.tools.Logger.out("WG on regarde si on peut caster un sort : _oUnicInfos.cs = " + this._oUnicInfos.cs, "dofus.datacenter.Item::castSpell", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/datacenter/Item.as", 311);
        return (this._oUnicInfos.cs != undefined);
    };
    _loc1.__get__canDestroy = function ()
    {
        return (this.superType != 14 && this.superType != 6);
    };
    _loc1.__get__canTrade = function ()
    {
        com.ankamagames.tools.Logger.out("WG CanTrade : supertye " + this.superType + " isCursed" + this.isCursed, "dofus.datacenter.Item::canTrade", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/datacenter/Item.as", 324);
        return (this.superType != 6);
    };
    ...
    _loc1.__get__price = function ()
    {
        ...
        {
            return (Math.max(0, Math.round(Number(this._oUnicInfos.p) * (this._nPriceMultiplicator == undefined ? (1) : (this._nPriceMultiplicator)))));
        }
        else
        {
            return (this._nPrice);
    ...
    }).getItemDescriptionEffects = function (aEffects, bVisibleOnly)
    {
        ...
        if (typeof(aEffects) == "object")
        {
            ...
            while (++_loc6, _loc6 < _loc5)
            {
                ...
                com.ankamagames.tools.Logger.out("WG new dofus.datacenter.Effect(" + _loc8 + ", " + _loc7[1] + ", " + _loc7[2] + ", " + _loc7[3] + ", " + _loc7[4] + ")", "dofus.datacenter.Item::getItemDescriptionEffects", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/datacenter/Item.as", 869);
    ...
    _loc1.addProperty("castSpell", _loc1.__get__castSpell, function ()
    {
    });
    ...
    _loc1.addProperty("canTrade", _loc1.__get__canTrade, function ()
    {
    });
    ...
    _loc1.addProperty("simpleDescription", _loc1.__get__simpleDescription, function ()
    {
    });
