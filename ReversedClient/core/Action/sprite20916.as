...
if (!dofus.managers.OptionsManager)
{
    ...
    _loc1.applyOption = function (sKey, mValue)
    {
        switch (sKey)
        {
            case "Grid":
            {
                if (this.api.datacenter.Game.isFight && mValue)
                {
            ...
            case "MovableBar":
            {
                this.api.ui.getUIComponent("Banner").displayMovableBar(false);
                break;
            } 
            case "HideSpellBar":
            {
    ...
    (_global.dofus.managers.OptionsManager = function (oAPI)
    {
        ...
        dofus.managers.OptionsManager._sSelf = this;
        this.initialize(oAPI);
    }).DEFAULT_VALUES = {loaded: true, Grid: true, Transparency: false, SpriteInfos: true, SpriteMove: false, MapInfos: false, AutoHideSmileys: true, StringCourse: true, PointsOverHead: true, ChatEffects: true, CreaturesMode: 50, Buff: false, GuildMessageSound: false, BannerShortcuts: false, StartTurnSound: true, TipsOnStart: false, DisplayStyle: "normal", DebugSizeIndex: 0, ServerPortIndex: 0, MovableBar: false, ViewAllMonsterInGroup: true, MovableBarSize: 5, ShortcutSet: 1, ShortcutSetDefault: 1, CharacterPreview: true, MapFilters: [0, 1, 0, 1], Aura: false, AudioMusicVol: 60, AudioEffectVol: 100, AudioEnvVol: 60, AudioMusicMute: false, AudioEffectMute: false, AudioEnvMute: false, FloatingTipsCoord: new com.ankamagames.types.Point(415, 30), DisplayingFreshTips: true, CensorshipFilter: true, BigStoreSellFilter: false, RememberAccountName: false, LastAccountNameUsed: "", DefaultQuality: "high", ConquestFilter: -2, FightGroupAutoLock: false, BannerIllustrationMode: "artwork", AskForWrongCraft: false, AdvancedLineOfSight: false, RemindTurnTime: true, HideSpellBar: false, SeeAllSpell: false, UseSpeakingItems: true, ConfirmDropItem: true, TimestampInChat: false, ViewDicesDammages: false};
    (_global.dofus.managers.OptionsManager = function (oAPI)
    {
        super();
        dofus.managers.OptionsManager._sSelf = this;
