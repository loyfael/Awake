...
if (!dofus.graphics.gapi.controls.FightChallengeIcon)
{
    ...
    {
        com.ankamagames.tools.Logger.out(this.challenge.id + " : " + this.challenge.iconPath, "dofus.graphics.gapi.controls.FightChallengeIcon::initCpt", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/controls/FightChallengeIcon.as", 65);
