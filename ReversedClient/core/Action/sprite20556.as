...
// [Initial MovieClip Action of sprite 20556]
#initclip 77
if (!ank.gapi.controls.list.SelectableRow)
{
    ...
    _loc1.draw = function ()
    {
        ...
        var _loc4 = _loc2.cellbgalpha != undefined ? (_loc2.cellbgalpha) : (_loc3 == -1 ? (0) : (100));
        var _loc5 = _loc2.cellselectedcolor;
        var _loc6 = _loc2.cellselectedalpha != undefined ? (_loc2.cellselectedalpha) : (_loc5 == -1 ? (0) : (100));
        var _loc7 = _loc2.cellovercolor;
        var _loc8 = _loc2.celloveralpha != undefined ? (_loc2.celloveralpha) : (_loc7 == -1 ? (0) : (100));
        this.over_mc.clear();
        this.selected_mc.clear();
        this.bg_mc.clear();
        ank.gapi.core.UIBasicComponent.drawRoundRect(this.over_mc, 0, 0, 1, 1, 0, _loc7, _loc8);
        ank.gapi.core.UIBasicComponent.drawRoundRect(this.selected_mc, 0, 0, 1, 1, 0, _loc5, _loc6);
        ank.gapi.core.UIBasicComponent.drawRoundRect(this.bg_mc, 0, 0, 1, 1, 0, typeof(_loc3) == "object" ? (Number(_loc3[this._nIndex % _loc3.length])) : (Number(_loc3)), _loc4);
