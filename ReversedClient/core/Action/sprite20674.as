...
if (!dofus.graphics.gapi.controls.ColorSelector)
{
    ...
    _loc1.__set__colors = function (aColors)
    {
        ...
        this.addToQueue({object: this, method: this.applyColor, params: [aColors[4], 4]});
        //return (this.colors());
    };
    ...
    {
        this._oColors = {color1: -1, color2: -1, color3: -1, color4: -1, color5: -1};
        this._oBakColors = {color1: -1, color2: -1, color3: -1, color4: -1, color5: -1};
    };
    _loc1.addListeners = function ()
    {
        ...
        this._btnColor4.addEventListener("click", this);
        ...
        this._btnColor4.addEventListener("over", this);
        ...
        this._btnColor4.addEventListener("out", this);
        ...
        this._mcRandomColor4.onPress = function ()
        {
            ref.click({target: this});
        };
        ...
        this._mcRandomColor4.onRollOver = function ()
        {
            ref.over({target: this});
        };
        ...
        this._mcRandomColor4.onRollOut = function ()
        {
            ref.out({target: this});
        };
    ...
    _loc1.hueVariation = function (nColor, nVariation, bNoBalance)
    {
        ...
        if (_loc5.h < 0.500000 && !bNoBalance)
        {
    ...
    {
        return (this.lightVariation(dofus.Constants.BREED_SKIN_BASE_COLOR[this._nSex][this._nBreed - 1], Math.random() * 0.200000 * (Math.random() > 0.500000 ? (1) : (-1))));
    };
