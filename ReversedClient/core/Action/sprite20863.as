...
if (!dofus.graphics.gapi.controls.craftviewer.CraftViewerCraftItem)
{
    ...
    _loc1.setValue = function (bUsed, sSuggested, oItem)
    {
        ...
        if (bUsed)
        {
            ...
            while (++_loc7, _loc7 < _loc6)
            {
                ...
                this["_lbl_quantity_" + _loc7]._visible = true;
                var _loc9 = 0;
                for (var o in _global.API.datacenter.Player.Inventory)
                {
                    var _loc10 = _global.API.datacenter.Player.Inventory[o];
                    if (_loc10.unicID == _loc8.unicID)
                    {
                        _loc9 = _loc9 + _loc10.Quantity;
                    } // end if
                } // end of for...in
                if (_loc9 < _loc8.Quantity)
                {
                    this["_lbl_quantity_" + _loc7].textColor = 16711680;
                }
                else
                {
                    this["_lbl_quantity_" + _loc7].textColor = 0;
                } // end else if
                this["_lbl_quantity_" + _loc7].text = _loc9 + "/" + _loc8.Quantity;
                this["_ctr" + _loc7].contentData = _loc8;
                this["_lblPlus" + _loc7]._visible = true;
            } // end while
            var _loc11 = _loc6;
            
            while (++_loc11, _loc11 < 8)
            {
                this["_ctr" + _loc11]._visible = false;
                this["_lblPlus" + _loc11]._visible = false;
                this["_lbl_quantity_" + _loc11]._visible = false;
            } // end while
        }
        else if (this._lblItemName.text != undefined)
        {
            ...
            while (++_loc12, _loc12 < 8)
            {
                this["_ctr" + _loc12]._visible = false;
                this["_lblPlus" + _loc12]._visible = false;
                this["_lbl_quantity_" + _loc12]._visible = false;
            } // end while
        } // end else if
    };
    _loc1.init = function ()
    {
        ...
        while (++_loc3, _loc3 < 8)
        {
            this["_ctr" + _loc3]._visible = this["_lblPlus" + _loc3]._visible = this["_lbl_quantity_" + _loc3]._visible = false;
        } // end while
