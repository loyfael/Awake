...
if (!ank.battlefield.Battlefield)
{
    ...
    _loc1.cleanMap = function (nPermanentLevel, bKeepData)
    {
        ...
        this.clearAllZones();
        this.clearPointer();
        if (_global.API.datacenter.Game.isFight && _global.API.kernel.OptionsManager.getOption("Grid"))
        {
            this.drawGrid();
        }
        else
    ...
    _loc1.setObject2Frame = function (nCellNum, frame, hide)
    {
        if (!this.isMapBuild)
        {
            return;
        } // end if
        this.mapHandler.setObject2Frame(nCellNum, frame, hide);
    };
    ...
    _loc1.addSprite = function (sID, spriteData)
    {
        ...
        com.ankamagames.tools.Logger.out("WG Battlefield.as:644 addSprite", "ank.battlefield.Battlefield::addSprite", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/battlefield/Battlefield.as", 647);
    ...
    _loc1.addCountdownOverHead = function (oSprite)
    {
        var _loc3 = oSprite.EffectsManager.getEffects();
        var _loc4 = new Array();
        var _loc5 = 0;
        
        while (++_loc5, _loc5 < _loc3.length)
        {
            if (_loc3[_loc5].type == 141)
            {
        ...
        if (_loc4.length > 0)
        {
            this.addSpriteOverHeadItem(oSprite.id, "countdown", dofus.graphics.battlefield.CountdownOverHead, [_loc4]);
        } // end if
    };
    _loc1.removeCountdownOverHead = function (oSprite)
    {
        this.hideSpriteOverHead(oSprite.id);
    };
    ...
    _loc1.drawGrid = function (bAll)
    {
        ...
        {
            com.ankamagames.tools.Logger.out("Dessin de la grille", "ank.battlefield.Battlefield::drawGrid", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/battlefield/Battlefield.as", 1102);
