...
if (!ank.gapi.controls.ColorPicker)
{
    ...
    _loc1.draw = function ()
    {
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcColorsV, 0, 0, 1, 1, 0, ank.gapi.controls.ColorPicker.COLORS_V, ank.gapi.controls.ColorPicker.ALPHAS_V, ank.gapi.controls.ColorPicker.MATRIX_V, "linear", ank.gapi.controls.ColorPicker.RATIOS_V);
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcColorsH, 0, 0, 1, 1, 0, ank.gapi.controls.ColorPicker.COLORS_H, ank.gapi.controls.ColorPicker.ALPHAS_H, ank.gapi.controls.ColorPicker.MATRIX_H, "linear", ank.gapi.controls.ColorPicker.RATIOS_H);
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcSlider, 0, 0, 1, 0.500000, 0, 16777215);
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcSlider, 0, 0.500000, 1, 0.500000, 0, 0);
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcSliderUp, 0, 0, 1, 1, 0, ank.gapi.controls.ColorPicker.COLORS_SLIDER, ank.gapi.controls.ColorPicker.ALPHAS_SLIDER, ank.gapi.controls.ColorPicker.MATRIX_H, "linear", ank.gapi.controls.ColorPicker.RATIOS_SLIDER);
    };
    ...
    _loc1.setColor = function (nColor)
    {
        ...
        var _loc11 = _loc10 < 0.500000 ? (_loc8 / (_loc7 + _loc6)) : (_loc8 / (2 - _loc7 - _loc6));
        if (_loc5 > _loc4)
        {
    ...
    {
        super();
    }).RATIOS_V = [0, 42.500000, 85, 127.500000, 170, 212.500000, 255];
    (_global.ank.gapi.controls.ColorPicker = function ()
    {
        super();
    ...
    {
        super();
    }).RATIOS_SLIDER = [0, 127.500000, 255];
