...
if (!dofus.aks.Guild)
{
    ...
    {
        this.api.ui.loadUIComponent("CreateGuild", "CreateGuild", {edit: false});
    };
    _loc1.onEdit = function (sExtraData)
    {
        var _loc3 = sExtraData.split(";");
        var _loc4 = _global.parseInt(_loc3[0]);
        var _loc5 = _loc3[1];
        ...
        this.api.ui.loadUIComponent("CreateGuild", "CreateGuild", {edit: true, level: _loc4, name: _loc5, backId: _loc6, backColor: _loc7, upId: _loc8, upColor: _loc9});
    };
    _loc1.onNewLevel = function (sExtraData)
    {
        ...
        while (++_loc7, _loc7 <= _loc5)
        {
            var _loc8 = this.api.lang.getText("GUILD_GAIN_LEVEL_" + _loc7);
            if (_loc8 != "!GUILD_GAIN_LEVEL_" + _loc7 + "!")
            {
                _loc6 = _loc6 + (_loc8 + "\n");
            } // end if
        } // end while
        this.api.kernel.showMessage(this.api.lang.getText("GUILD_LEVEL_UP"), this.api.lang.getText("GUILD_NEW_LEVEL", [_loc5, _loc6]), "ERROR_BOX", {name: "NewGuildLevel"});
        this.api.datacenter.Player.guildInfos.level = _loc5;
    };
    _loc1.onCreate = function (bSuccess, sExtraData)
    {
        if (bSuccess)
        {
            ...
            this.api.ui.loadUIAutoHideComponent("Friends", "Friends", {_sCurrentTab: "Clan"}, {bStayIfPresent: true});
        }
        else
        {
            switch (sExtraData)
    ...
    _loc1.onInfosGeneral = function (sExtraData)
    {
        ...
        this.api.datacenter.Player.guildInfos.setGeneralInfos(_loc4, _loc5, _loc6, _loc7, _loc8, _loc9);
    };
    _loc1.onInfosMembers = function (sExtraData)
    {
        ...
        var _loc6 = _loc5.members.length == 0;
        var _loc7 = 0;
        ...
        while (++_loc7, _loc7 < _loc4.length)
        {
            ...
            _loc9.id = Number(_loc8[0]);
            if (_loc3)
            {
                _loc9.name = _loc9.account = _loc8[1];
                _loc9.level = Number(_loc8[2]);
                _loc9.gfx = Number(_loc8[3]);
                _loc9.rank = Number(_loc8[4]);
                _loc9.rankOrder = this.api.lang.getRankInfos(_loc9.rank).o;
                _loc9.winxp = Number(_loc8[5]);
                _loc9.percentxp = Number(_loc8[6]);
                _loc9.rights = new dofus.datacenter.GuildRights(Number(_loc8[7]));
                _loc9.state = Number(_loc8[8]);
                _loc9.alignement = Number(_loc8[9]);
                _loc9.lastConnection = Number(_loc8[10]);
                _loc9.isLocalPlayer = _loc9.id == this.api.datacenter.Player.ID;
                if (_loc6)
                {
                    _loc5.members.push(_loc9);
                }
                else
                {
                    var _loc10 = _loc5.members.findFirstItem("id", _loc9.id);
                    if (_loc10.index != -1)
                    {
                        _loc5.members.updateItem(_loc10.index, _loc9);
                    }
                    else
                    {
                        _loc5.members.push(_loc9);
            ...
            var _loc11 = _loc5.members.findFirstItem("id", _loc9.id);
            if (_loc11.index != -1)
            {
        ...
        if (_loc7.index != -1)
        {
            ...
            while (++_loc9, _loc9 < _loc4.length)
            {
                ...
                if (_loc3)
                {
                    ...
                    _loc11.color4 = _global.parseInt(_loc10[7], 36);
                    _loc11.color4 = _global.parseInt(_loc10[8], 36);
    ...
    _loc1.onInsufficientMember = function ()
    {
        this.api.kernel.showMessage(undefined, "<b>Attention</b> : Votre clan comporte moins de quatre joueurs, il sera automatiquement supprimé à défaut d\'un nouveau membre dans les prochaines 24 heures !", "ERROR_CHAT");
    };
    _loc1.onRemoved = function ()
    {
        this.api.kernel.showMessage(undefined, "<b>Votre clan a été supprimé !</b>", "ERROR_CHAT");
        delete this.api.datacenter.Player.guildInfos;
        this.api.ui.unloadUIComponent("Friends");
        this.api.ui.unloadUIComponent("Ladder");
    };
    _loc1.onAutoBann = function (name)
    {
        this.api.kernel.showMessage(undefined, "<b>" + name + "</b> a été banni du clan pour avoir été déconnecté trop longtemps !", "ERROR_CHAT");
    };
    _loc1.onBann = function (bSuccess, sExtraData)
    {
        if (bSuccess)
        {
            ...
            {
                this.api.kernel.showMessage(undefined, "<b>" + _loc6 + "</b> a quitté le clan.", "INFO_CHAT");
            }
            else if (this.api.datacenter.Player.Name == _loc6)
            {
            ...
            {
                this.api.kernel.showMessage(undefined, "<b>" + _loc6 + "</b> a été banni du clan par " + _loc5 + ".", "INFO_CHAT");
            } // end else if
        }
        else
        {
    ...
    {
        com.ankamagames.tools.Logger.out(oEvent.target._name, "dofus.aks.Guild::cancel", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Guild.as", 1195);
