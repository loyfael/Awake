...
if (!dofus.utils.DofusTranslator)
{
    ...
    _loc1.getMapSuperAreaInfos = function ()
    {
        return (this.getValueFromSOXtra("MA").sua);
    };
    ...
    _loc1.getAllTitle = function ()
    {
        return (this.getValueFromSOXtra("PT"));
    };
    _loc1.getAchievementInfo = function (nID)
    {
        return (this.getValueFromSOXtra("a").a[nID]);
    };
    _loc1.getAchievementInfos = function ()
    {
        return (this.getValueFromSOXtra("a"));
    };
