        ...
        this._mcViewAllSpell.onRelease = function ()
        {
            ...
            while (++_loc2, _loc2 < dofus.graphics.gapi.ui.SpellViewerOnCreate.SPELLS_DISPLAYED)
            {
                ...
                _loc3.onEnterFrame = function ()
                {
                    ...
                    if (Math.abs(this._x - aTarget[this._name].x) < 0.500000 && (Math.abs(this._y - aTarget[this._name].y) < 0.500000 && Math.abs(this._alpha - 100) < 0.500000))
                    {
            ...
            this.onEnterFrame = function ()
            {
                ...
                if (Math.abs(ref._mcSpellDesc._y - ref._mcPlacerAllSpell._y) < 0.500000)
                {
