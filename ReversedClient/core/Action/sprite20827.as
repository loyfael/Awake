...
if (!dofus.datacenter.Character)
{
    ...
    {
        return (this.isSlow ? (0.500000) : (super.speedModerator));
    };
    ...
    _loc1.isInDungeonTeam = function ()
    {
        return (this._nDungeonTeam != null && this._nDungeonTeam > 0);
    };
    _loc1.__get__DungeonTeam = function ()
    {
        return (this._nDungeonTeam);
    };
    _loc1.__get__DungeonTeamDungeonId = function ()
    {
        return (this._nDungeonTeamDungeonId);
    };
    _loc1.__get__DungeonTeamState = function ()
    {
        return (this._nDungeonTeamState);
    };
    _loc1.setDungeonTeamInfos = function (teamId, dungeonId, nState)
    {
        var _loc5 = this._nDungeonTeam != teamId || (this._nDungeonTeamDungeonId != dungeonId || this._nDungeonTeamState != nState);
        this._nDungeonTeam = teamId == undefined ? (null) : (teamId);
        this._nDungeonTeamDungeonId = dungeonId == undefined ? (null) : (dungeonId);
        this._nDungeonTeamState = nState == undefined ? (null) : (nState);
        if (_loc5)
        {
    ...
    _loc1.updateDungeonState = function ()
    {
        if (_global.isNaN(this._nDungeonTeamState))
        {
            this.api.gfx.removeSpriteOverHeadLayer(this.id, "dungeonTeamState");
        }
        else
        {
            this.api.gfx.addSpriteOverHeadItem(this.id, "dungeonTeamState", dofus.graphics.battlefield.DungeonTeamOverHead, [this._nDungeonTeamState]);
        } // end else if
    };
    ...
    _loc1.addProperty("DungeonTeam", _loc1.__get__DungeonTeam, function ()
    {
    });
    ...
    _loc1.addProperty("DungeonTeamState", _loc1.__get__DungeonTeamState, function ()
    {
    });
    ...
    _loc1.addProperty("DungeonTeamDungeonId", _loc1.__get__DungeonTeamDungeonId, function ()
    {
    });
