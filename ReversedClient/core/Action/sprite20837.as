...
if (!ank.gapi.controls.Fps)
{
    ...
    _loc1.createChildren = function ()
    {
        ...
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcBack, 0, 0, 1, 1, 0, 16777215);
    ...
    _loc1.draw = function ()
    {
        ...
        {
            ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcBack, _loc2.backcolor);
        } // end if
