...
if (!dofus.graphics.gapi.ui.Inventory)
{
    ...
    _loc1.showItemInfos = function (oItem)
    {
        ...
        else
        {
            ...
            this._winItvWindow.title = _loc3.name;
    ...
    _loc1.init = function ()
    {
        ...
        this.showCharacterPreview(this.api.kernel.OptionsManager.getOption("CharacterPreview"));
        var _loc3 = this.api.datacenter.Player.Level;
        if (_loc3 >= 5)
        {
            this._mcRune1Cross._visible = false;
        } // end if
        if (_loc3 >= 200)
        {
            this._mcRune2Cross._visible = false;
        } // end if
    ...
    _loc1.addListeners = function ()
    {
        ...
        this._btnFilterColor.addEventListener("click", this);
        this._btnFilterExclu.addEventListener("click", this);
        ...
        this._btnFilterColor.addEventListener("over", this);
        this._btnFilterExclu.addEventListener("over", this);
        ...
        this._btnFilterColor.addEventListener("out", this);
        this._btnFilterExclu.addEventListener("out", this);
    ...
    _loc1.initTexts = function ()
    {
        ...
        this._winBg.title = this.api.lang.getText("MYOBJECTS");
    ...
    _loc1.initFilter = function ()
    {
        switch (this.api.datacenter.Basics.inventory_filter)
        {
            case "hat":
            {
                ...
                this._aSelectedSuperTypes = dofus.graphics.gapi.ui.Inventory.FILTER_HAT;
            ...
            case "potion":
            {
                ...
                this._aSelectedSuperTypes = dofus.graphics.gapi.ui.Inventory.FILTER_POTION;
            ...
            case "resource":
            {
                ...
                this._aSelectedSuperTypes = dofus.graphics.gapi.ui.Inventory.FILTER_RESOURCE;
            ...
            case "recipe":
            {
                ...
                this._aSelectedSuperTypes = dofus.graphics.gapi.ui.Inventory.FILTER_RUNE;
                this._btnSelectedFilterButton = this._btnFilterRecipe;
                break;
            } 
            case "color":
            {
                this._btnFilterColor.selected = true;
                this._aSelectedSuperTypes = dofus.graphics.gapi.ui.Inventory.FILTER_COLOR;
                this._btnSelectedFilterButton = this._btnFilterColor;
                break;
            } 
            case "exclu":
            {
                this._btnFilterExclu.selected = true;
                this._aSelectedSuperTypes = dofus.graphics.gapi.ui.Inventory.FILTER_EXCLU;
                this._btnSelectedFilterButton = this._btnFilterExclu;
                break;
            } 
            case "no_filter":
            default:
            {
                ...
                this._aSelectedSuperTypes = dofus.graphics.gapi.ui.Inventory.FILTER_NONE;
                this._btnSelectedFilterButton = this._btnNoFilter;
                this.api.datacenter.Basics.inventory_filter = "nofilter";
            } 
        } // End of switch
    };
    _loc1.initData = function ()
    {
        this._svCharacterViewer.zoom = 150;
        ...
        if (_loc3 != undefined)
        {
            ...
            if (_loc5)
            {
                for (var i in dofus.graphics.gapi.ui.Inventory.CONTAINER_BY_TYPE["type" + _loc3])
                {
                    ...
                    com.ankamagames.tools.Logger.out(_loc6.contentPath, "dofus.graphics.gapi.ui.Inventory::enabledFromSuperType", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Inventory.as", 529);
            ...
            else
            {
                for (var i in dofus.graphics.gapi.ui.Inventory.CONTAINER_BY_TYPE["type" + _loc3])
                {
                    ...
                    if (_loc8.contentData != undefined && _loc8.contentData.unicID == oItem.unicID)
                    {
                        return;
                    } // end if
                    var _loc7 = _loc8;
    ...
    _loc1.updateData = function (bOnlyGrid)
    {
        ...
        if (this.api.datacenter.Basics.inventory_filter == "nofilter")
        {
            _loc5.sortOn(["_itemType", "_itemName"]);
        }
        else
        {
            _loc5.sortOn("_itemName");
        } // end else if
    ...
    {
        this._winItvWindow._visible = !bHide;
        this._bgItemViewer._visible = !bHide;
        this._fxItemViewer._visible = !bHide;
        ...
        if (oEvent.target != this._btnSelectedFilterButton)
        {
            ...
            switch (oEvent.target._name)
            {
                case "_btnFilterHat":
                {
                    ...
                    this.api.datacenter.Basics.inventory_filter = "hat";
                    break;
                } 
                case "_btnFilterPotion":
                {
                    ...
                    this.api.datacenter.Basics.inventory_filter = "potion";
                    break;
                } 
                case "_btnFilterResource":
                {
                    ...
                    this.api.datacenter.Basics.inventory_filter = "resource";
                    break;
                } 
                case "_btnFilterRecipe":
                {
                    ...
                    this.api.datacenter.Basics.inventory_filter = "recipe";
                    break;
                } 
                case "_btnFilterColor":
                {
                    this._aSelectedSuperTypes = dofus.graphics.gapi.ui.Inventory.FILTER_COLOR;
                    this._lblFilter.text = this.api.lang.getText("COLOR");
                    this.api.datacenter.Basics.inventory_filter = "color";
                    break;
                } 
                case "_btnFilterExclu":
                {
                    this._aSelectedSuperTypes = dofus.graphics.gapi.ui.Inventory.FILTER_EXCLU;
                    this._lblFilter.text = this.api.lang.getText("EXCLU");
                    this.api.datacenter.Basics.inventory_filter = "exclu";
                    break;
                } 
                case "_btnNoFilter":
                default:
    ...
    {
        var _loc3 = oItem.superType;
        com.ankamagames.tools.Logger.out("SuperType de l\'item " + _loc3, "dofus.graphics.gapi.ui.Inventory::getFreeSlot", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Inventory.as", 1068);
        var _loc4 = "type" + _loc3;
        for (var i in dofus.graphics.gapi.ui.Inventory.CONTAINER_BY_TYPE[_loc4])
        {
            if (dofus.graphics.gapi.ui.Inventory.CONTAINER_BY_TYPE[_loc4][i] != "_ctr16")
            {
                if (this[dofus.graphics.gapi.ui.Inventory.CONTAINER_BY_TYPE[_loc4][i]].contentData == undefined)
                {
                    return (this[dofus.graphics.gapi.ui.Inventory.CONTAINER_BY_TYPE[_loc4][i]]);
                } // end if
            } // end if
        } // end of for...in
        return;
    ...
    _loc1.equipItem = function (oItem)
    {
        ...
        com.ankamagames.tools.Logger.out("WG on a trouvé le slot " + _loc5 + " pour l\'item" + oItem, "dofus.graphics.gapi.ui.Inventory::equipItem", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Inventory.as", 1089);
        if (_loc5 != undefined)
        {
    ...
    _loc1.over = function (oEvent)
    {
        switch (oEvent.target)
        {
            ...
            case this._btnFilterColor:
            {
                this.api.ui.showTooltip(this.api.lang.getText("COLOR"), oEvent.target, -20);
                break;
            } 
            case this._btnFilterExclu:
            {
                this.api.ui.showTooltip(this.api.lang.getText("EXCLU"), oEvent.target, -20);
                break;
            } 
    ...
    {
        super();
    }).CONTAINER_BY_TYPE = {type1: ["_ctr0"], type2: ["_ctr1"], type3: ["_ctr2", "_ctr4"], type4: ["_ctr3"], type5: ["_ctr5"], type6: ["_ctrMount"], type8: ["_ctr1"], type9: ["_ctr8", "_ctrMount"], type10: ["_ctr6"], type11: ["_ctr7"], type12: ["_ctr8", "_ctr16"], type13: ["_ctr1", "_ctr9", "_ctr10", "_ctr11", "_ctr12", "_ctr13", "_ctr14"], type7: ["_ctr15"]};
    (_global.dofus.graphics.gapi.ui.Inventory = function ()
    {
        super();
    ...
    {
        super();
    }).FILTER_HAT = [false, false, false, false, true, true, false, false, false, false, true, true, false, false, false];
    (_global.dofus.graphics.gapi.ui.Inventory = function ()
    {
        super();
    ...
    {
        super();
    }).FILTER_COLOR = [false, false, false, false, false, false, false, true, false, false, false, false, false, false, false];
    (_global.dofus.graphics.gapi.ui.Inventory = function ()
    {
        super();
    }).FILTER_EXCLU = [false, true, false, false, false, false, true, false, false, false, false, false, false, false, true];
    (_global.dofus.graphics.gapi.ui.Inventory = function ()
    {
        super();
    }).FILTER_RUNE = [false, false, false, true, false, false, false, false, false, false, false, false, false, false, false];
    (_global.dofus.graphics.gapi.ui.Inventory = function ()
    {
        super();
    }).FILTER_NONE = [true, true, true, true, true, true, false, true, true, true, true, true, true, true, true];
