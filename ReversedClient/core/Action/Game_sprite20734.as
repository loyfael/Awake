...
if (!dofus.aks.Game)
{
    ...
    _loc1.__set__isBusy = function (b)
    {
        this._bIsBusy = b;
        //return (this.isBusy());
    };
    ...
    _loc1.videoComplete = function ()
    {
        this.aks.send("wDv");
    };
    _loc1.sendChoice = function (choiceId)
    {
        this.aks.send("wHN" + choiceId);
    };
    ...
    _loc1.onJoin = function (sExtraData)
    {
        ...
        var bCanBeCanceled = _loc3[1] == "0" ? (false) : (true);
        var bCanReady = _loc3[2] == "0" ? (false) : (true);
        var _loc5 = _loc3[3] == "0" ? (false) : (true);
        var nTimer = Number(_loc3[4]);
        var _loc6 = Number(_loc3[5]);
        this.api.datacenter.Game = new dofus.datacenter.Game();
        this.api.datacenter.Game.state = _loc4;
        this.api.datacenter.Game.fightType = _loc6;
        this.api.datacenter.Game.isSpectator = _loc5;
        if (!_loc5)
        {
            this.api.datacenter.Player.data.initAP(false);
            this.api.datacenter.Player.data.initMP(false);
        ...
        var _loc7 = this.api.ui.getUIComponent("Banner");
        _loc7.shortcuts.setCurrentTab(dofus.graphics.gapi.controls.MouseShortcuts.TAB_SPELLS);
        _loc7.showButtonBar(false);
        this.api.gfx.cleanMap(1);
        if (!this.aks.Dungeon.isVersusFight() && !this.aks.Dungeon.isCustomAnimationFight())
        {
            this.onFightStart({ready: bCanReady, canceled: bCanBeCanceled, timer: nTimer, fightType: _loc6});
        }
        else
        {
            var ref = this;
            ...
            var _loc8 = function ()
            {
                if (ref.api.ui.getUIComponent("CenterTextMap") == undefined)
                {
                    ref.aks.Dungeon.onIntroStart({ready: bCanReady, canceled: bCanBeCanceled, timer: nTimer});
                    _global.clearInterval(iInterval);
                } // end if
            };
            iInterval = _global.setInterval(_loc8, 500);
        } // end else if
    };
    _loc1.onFightStart = function (oEvent)
    {
        this.api.ui.unloadUIComponent("Versus");
        this.api.ui.unloadUIComponent("FightStartAnimation");
        if (oEvent.ready)
        {
            this.api.ui.getUIComponent("Banner").setStateWaitReady(true);
        } // end if
        if (!_global.isNaN(oEvent.timer))
        {
            this.api.ui.getUIComponent("Banner").startTimer(oEvent.timer / 1000);
        } // end if
        ...
        if (this.api.datacenter.Game.fightType != 4)
        {
            this.aks.Dungeon.onFightStart();
        } // end if
        if (this.api.ui.getUIComponent("Banner").getFightOptionPanel() == undefined)
        {
            this.api.ui.getUIComponent("Banner").showFightOptionPanel();
        } // end if
    };
    ...
    _loc1.onReady = function (sExtraData)
    {
        ...
        {
            this._bSword = true;
            this.api.gfx.addSpriteExtraClip(_loc4, dofus.Constants.READY_FILE, undefined, true);
        }
        else
        {
            this._bSword = false;
            this.api.gfx.removeSpriteExtraClip(_loc4, true);
        } // end else if
    };
    _loc1.onStartToPlay = function ()
    {
        ...
        this.api.ui.getUIComponent("Banner").getFightOptionPanel().onGameRunning();
        this.api.ui.loadUIComponent("Timeline", "Timeline");
        this.api.ui.getUIComponent("Banner").setStateWaitReady(false);
    ...
    _loc1.onTurnStart = function (sExtraData)
    {
        ...
        if (this.api.datacenter.Player.isCurrentPlayer)
        {
            ...
            this.api.ui.loadUIComponent("YourTurn", "YourTurn", {}, {bForceLoad: true});
        }
        else
        {
            this.api.gfx.setInteraction(ank.battlefield.Constants.INTERACTION_CELL_NONE);
        ...
        {
            var _loc7 = new Array();
            _loc7[0] = _loc6.color1;
            _loc7[1] = _loc6.color2;
            _loc7[2] = _loc6.color3;
            _loc7[3] = _loc6.color4;
            _loc7[4] = _loc6.color5;
        ...
        if (this._bSword)
        {
            ...
            for (var k in _loc8)
            {
                this.api.gfx.removeSpriteExtraClip(k, true);
            } // end of for...in
        } // end if
    };
    ...
    _loc1.onMovement = function (sExtraData, bIsSummoned)
    {
        ...
        while (++_loc5, _loc5 < _loc4.length)
        {
            ...
            if (_loc8)
            {
                ...
                switch (_loc23)
                {
                    ...
                    case "-5":
                    {
                        ...
                        _loc45.color4 = _loc10[10];
                        _loc45.color5 = _loc10[11];
                        _loc45.accessories = _loc10[12];
                        _loc45.guildName = _loc10[13];
                        _loc45.emblem = _loc10[14];
                        _loc45.offlineType = _loc10[15];
                    ...
                    default:
                    {
                        ...
                        if (this.api.datacenter.Game.isFight)
                        {
                            ...
                            _loc52.color4 = _loc10[13];
                            _loc52.color5 = _loc10[14];
                            _loc52.accessories = _loc10[15];
                            _loc52.LP = _loc10[16];
                            _loc52.AP = _loc10[17];
                            _loc52.MP = _loc10[18];
                            _loc52.resistances = new Array(Number(_loc10[19]), Number(_loc10[20]), Number(_loc10[21]), Number(_loc10[22]), Number(_loc10[23]), Number(_loc10[24]), Number(_loc10[25]));
                            _loc52.team = _loc10[26];
                            if (_loc10[27].indexOf(",") != -1)
                            {
                                var _loc53 = _loc10[27].split(",");
                        ...
                        else
                        {
                            ...
                            _loc52.color5 = _loc10[14];
                            _loc52.accessories = _loc10[15];
                            _loc52.aura = _loc10[16];
                            if (_loc10[17].indexOf(",") != -1)
                            {
                                var _loc60 = _loc10[17].split(",");
                                _loc52.dungeonTeam = Number(_loc60[0]);
                                _loc52.dungeonId = Number(_loc60[1]);
                                _loc52.dungeonTeamState = Number(_loc60[2]);
                            }
                            else
                            {
                                _loc52.dungeonTeam = null;
                                _loc52.dungeonTeamState = null;
                                _loc52.dungeonId = null;
                            } // end else if
                            _loc52.emote = _loc10[18];
                            _loc52.emoteTimer = _loc10[19];
                            _loc52.guildName = _loc10[20];
                            _loc52.guildLevel = _loc10[21];
                            _loc52.emblem = _loc10[22];
                            _loc52.restrictions = _loc10[23];
                            if (_loc10[24].indexOf(",") != -1)
                            {
                                var _loc61 = _loc10[24].split(",");
                                var _loc62 = Number(_loc61[0]);
                                var _loc63 = _global.parseInt(_loc61[1], 16);
                                var _loc64 = _global.parseInt(_loc61[2], 16);
                                var _loc65 = _global.parseInt(_loc61[3], 16);
                                if (_loc63 == -1 || _global.isNaN(_loc63))
                                {
                                    _loc63 = this.api.datacenter.Player.color1;
                                } // end if
                                if (_loc64 == -1 || _global.isNaN(_loc64))
                                {
                                    _loc64 = this.api.datacenter.Player.color2;
                                } // end if
                                if (_loc65 == -1 || _global.isNaN(_loc65))
                                {
                                    _loc65 = this.api.datacenter.Player.color3;
                                } // end if
                                if (!_global.isNaN(_loc62))
                                {
                                    var _loc66 = new dofus.datacenter.Mount(_loc62, Number(_loc21));
                                    _loc66.customColor1 = _loc63;
                                    _loc66.customColor2 = _loc64;
                                    _loc66.customColor3 = _loc65;
                                    _loc52.mount = _loc66;
                                } // end if
                            }
                            else
                            {
                                var _loc67 = Number(_loc10[24]);
                                if (!_global.isNaN(_loc67))
                                {
                                    _loc52.mount = new dofus.datacenter.Mount(_loc67, Number(_loc21));
                                } // end if
                            } // end else if
                        } // end else if
                        if (_loc7)
                        ...
                        var _loc68 = _loc51.split(",");
                        _loc52.alignment = new dofus.datacenter.Alignment(Number(_loc68[0]), Number(_loc68[1]));
                        _loc52.rank = new dofus.datacenter.Rank(Number(_loc68[2]));
                        _loc52.alignment.fallenAngelDemon = _loc68[4] == 1;
                        if (_loc68.length > 3 && _loc14 != this.api.datacenter.Player.ID)
                        {
                            if (this.api.lang.getAlignmentCanViewPvpGain(this.api.datacenter.Player.alignment.index, Number(_loc52.alignment.index)))
                            {
                                var _loc69 = Number(_loc68[3]) - _global.parseInt(_loc14);
                                var _loc70 = this.api.lang.getConfigText("PVP_VIEW_BONUS_MINOR_LIMIT");
                                var _loc71 = this.api.lang.getConfigText("PVP_VIEW_BONUS_MINOR_LIMIT_PRC");
                                var _loc72 = this.api.lang.getConfigText("PVP_VIEW_BONUS_MAJOR_LIMIT");
                                var _loc73 = this.api.lang.getConfigText("PVP_VIEW_BONUS_MAJOR_LIMIT_PRC");
                                var _loc74 = 0;
                                if (this.api.datacenter.Player.Level * (1 - _loc71 / 100) > _loc69)
                                {
                                    _loc74 = -1;
                                } // end if
                                if (this.api.datacenter.Player.Level - _loc69 > _loc70)
                                {
                                    _loc74 = -1;
                                } // end if
                                if (this.api.datacenter.Player.Level * (1 + _loc73 / 100) < _loc69)
                                {
                                    _loc74 = 1;
                                } // end if
                                if (this.api.datacenter.Player.Level - _loc69 < _loc72)
                                {
                                    _loc74 = 1;
                                } // end if
                                _loc52.pvpGain = _loc74;
                            } // end if
                        } // end if
                        ...
                        var _loc75 = this.sliptGfxData(_loc17);
                        var _loc76 = _loc75.gfx;
                        this.splitGfxForScale(_loc76[0], _loc52);
                        _loc52.title = _loc25;
                        ...
                        var _loc77 = _loc14;
                        var _loc78 = _loc75.shape == "circle" ? (0) : (2);
                        var _loc79 = 1;
                        
                        while (++_loc79, _loc79 < _loc76.length)
                        {
                            if (_loc76[_loc79] == "")
                            {
                                continue;
                            } // end if
                            var _loc80 = _loc14 + "_" + _loc79;
                            var _loc81 = new Object();
                            this.splitGfxForScale(_loc76[_loc79], _loc81);
                            var _loc82 = new ank.battlefield.datacenter.Sprite(_loc80, ank.battlefield.mc.Sprite, dofus.Constants.CLIPS_PERSOS_PATH + _loc81.gfxID + ".swf");
                            _loc82.allDirections = false;
                            this.api.gfx.addLinkedSprite(_loc80, _loc77, _loc78, _loc82);
                            if (!_global.isNaN(_loc81.scaleX))
                            {
                                this.api.gfx.setSpriteScale(_loc82.id, _loc81.scaleX, _loc81.scaleY);
                            } // end if
                            switch (_loc75.shape)
                            {
                                case "circle":
            ...
            var _loc83 = _loc6.substr(1);
            var _loc84 = this.api.datacenter.Sprites.getItemAt(_loc83);
            this.onSpriteMovement(_loc8, _loc84);
        } // end while
    };
    ...
    _loc1.onFrameObject2 = function (sExtraData)
    {
        ...
        while (++_loc4, _loc4 < _loc3.length)
        {
            ...
            var _loc10 = _loc5[2] == "2" ? (true) : (false);
            if (_loc8 && !_loc10)
            {
                this.api.gfx.setObject2Interactive(_loc6, _loc9, 2);
            } // end if
            this.api.gfx.setObject2Frame(_loc6, _loc7, _loc10);
        } // end while
    };
    ...
    _loc1.onEffect = function (sExtraData)
    {
        ...
        while (++_loc12, _loc12 < _loc5.length)
        {
            ...
            this.api.gfx.addCountdownOverHead(_loc15);
        } // end while
    };
    ...
    _loc1.onLeave = function ()
    {
        ...
        this.api.ui.unloadUIComponent("YourTurn");
    ...
    _loc1.onEnd = function (sExtraData)
    {
        ...
        if (this.api.datacenter.Game.fightType == 4)
        {
            var _loc4 = {winners: [], loosers: [], collectors: []};
            ...
            {
                var _loc6 = _loc3[0].split(";");
                _loc4.duration = Number(_loc6[0]);
                _loc5 = Number(_loc6[1]);
            } // end else if
            this.api.datacenter.Basics.aks_game_end_bonus = _loc5;
            var _loc7 = Number(_loc3[1]);
            var _loc8 = Number(_loc3[2]);
            _loc4.fightType = _loc8;
            var _loc9 = new ank.utils.ExtendedArray();
            var _loc10 = 0;
            this.parsePlayerData(_loc4, 3, _loc7, _loc3, _loc8, _loc10, _loc9);
        }
        else
        {
            var _loc11 = _global.isNaN(Number(_loc3[0]));
            var _loc12 = -1;
            var _loc13 = -1;
            if (_loc11)
            {
                _loc12 = Number(_loc3[1]);
                _loc13 = Number(_loc3[2]);
            } // end if
            this.aks.Dungeon.onParseItemEndDungeon(this, _loc11, _loc12, _loc13);
        } // end else if
    };
    ...
    _loc1.onParseItemEnd = function (nSenderID, oResults, eaFightDrop, nKamaDrop)
    {
        ...
        var _loc10 = this.api.datacenter.Sprites.getItemAt(this.api.datacenter.Player.ID).sequencer;
        this._bIsBusy = false;
        if (_loc10 != undefined)
        {
    ...
    _loc1.onCreateSolo = function ()
    {
        ...
        this.api.ui.getUIComponent("Banner").shortcuts.setCurrentTab(dofus.graphics.gapi.controls.MouseShortcuts.TAB_SPELLS);
        ...
        if (!this.api.gfx.isMapBuild)
        {
            if (this.api.ui.getUIComponent("Banner") == undefined)
            {
                ...
                this.api.ui.loadUIComponent("WGBanner", "Banner", {data: this.api.datacenter.Player}, {bAlwaysOnTop: true});
        ...
        else
        {
            ...
            _loc2.showButtonBar(true);
            this.api.ui.getUIComponent("Banner").hideFightOptionPanel();
            this.api.ui.getUIComponent("Banner").setStateWaitReady(false);
            ...
            if (_loc7 >= _loc8)
            {
                ...
                for (var k in _loc10)
                {
                    ...
                    if (!_loc11.bInCreaturesMode)
                    {
                        ...
                        var _loc12 = dofus.Constants.CLIPS_PERSOS_PATH + _loc11.Guild + String(_loc11._nSex + 2) + ".swf";
    ...
    _loc1.addProperty("isBusy", _loc1.__get__isBusy, _loc1.__set__isBusy);
