...
if (!ank.battlefield.mc.Sprite)
{
    ...
    _loc1.onLoadInit = function (mc)
    {
        this.onEnterFrame = function ()
        {
            ...
            if (this._bGfxLoaded && (!this._oData.isMounting || this._bChevauchorGfxLoaded))
            {
                ...
                {
                    this.setAnimTimer(this._oData.startAnimation, false, false, 10000);
                } // end else if
                this.setScale(this._oData.gfxScale);
                this._oData.updateDungeonState();
    ...
    (_global.ank.battlefield.mc.Sprite = function (b, sd, d)
    {
        super();
        this.initialize(b, sd, d);
    }).WALK_SPEEDS = [0.070000, 0.060000, 0.060000, 0.060000, 0.070000, 0.060000, 0.060000, 0.060000];
    (_global.ank.battlefield.mc.Sprite = function (b, sd, d)
    {
        super();
        this.initialize(b, sd, d);
    }).MOUNT_SPEEDS = [0.230000, 0.200000, 0.200000, 0.200000, 0.230000, 0.200000, 0.200000, 0.200000];
    (_global.ank.battlefield.mc.Sprite = function (b, sd, d)
    {
        super();
        this.initialize(b, sd, d);
    }).RUN_SPEEDS = [0.170000, 0.150000, 0.150000, 0.150000, 0.170000, 0.150000, 0.150000, 0.150000];
} // end if
#endinitclip
