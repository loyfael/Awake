...
if (!ank.battlefield.datacenter.Sprite)
{
    ...
    _loc1.initialize = function (sID, fClipClass, sGfxFile, nCellNum, nDir)
    {
        ...
        this._oSequencer = new ank.utils.Sequencer(10000);
        this._bInMove = false;
        this._bVisible = true;
        this._bClear = false;
    ...
    _loc1.__get__gfxScale = function ()
    {
        return (this._nGfxScale);
    };
    _loc1.__set__gfxScale = function (nGfxScale)
    {
        this._nGfxScale = nGfxScale;
        //return (this.gfxScale());
    };
    ...
    _loc1.__get__color4 = function ()
    {
        return (this._nColor4);
    };
    _loc1.__set__color4 = function (value)
    {
        this._nColor4 = Number(value);
        //return (this.color4());
    };
    _loc1.__get__color5 = function ()
    {
        return (this._nColor5);
    };
    _loc1.__set__color5 = function (value)
    {
        this._nColor5 = Number(value);
        //return (this.color5());
    };
    ...
    _loc1.addProperty("color4", _loc1.__get__color4, _loc1.__set__color4);
    _loc1.addProperty("forceWalk", _loc1.__get__forceWalk, _loc1.__set__forceWalk);
    _loc1.addProperty("color5", _loc1.__get__color5, _loc1.__set__color5);
    _loc1.addProperty("gfxScale", _loc1.__get__gfxScale, _loc1.__set__gfxScale);
    ...
    _loc1._nSpeedModerator = 1.600000;
