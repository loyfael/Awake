...
if (!dofus.sounds.AudioElement)
{
    ...
    var _loc1 = (_global.dofus.sounds.AudioElement = function (uniqID, file, linkedClip, streaming)
    {
        if (uniqID == undefined)
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.NullPointerException(this, "AudioElement", "", "uniqID"), "dofus.sounds.AudioElement::AudioElement", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/sounds/AudioElement.as", 245);
            return;
        } // end if
        if (file == undefined)
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.NullPointerException(this, "AudioElement", "", "file"), "dofus.sounds.AudioElement::AudioElement", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/sounds/AudioElement.as", 250);
            return;
        } // end if
        if (linkedClip == undefined)
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.NullPointerException(this, "AudioElement", "", "linkedClip"), "dofus.sounds.AudioElement::AudioElement", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/sounds/AudioElement.as", 255);
            return;
        } // end if
    ...
    _loc1.__set__volume = function (nValue)
    {
        ...
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.ValueOutOfRangeException(this, "AudioElement", "set volume", "nValue", nValue, 0, 100), "dofus.sounds.AudioElement::volume", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/sounds/AudioElement.as", 115);
            return;
        } // end if
    ...
    _loc1.__set__loops = function (nValue)
    {
        ...
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.ValueOutOfRangeException(this, "AudioElement", "set loops", "nValue", nValue, dofus.sounds.AudioElement.ONESHOT_SAMPLE, dofus.sounds.AudioElement.INFINITE_LOOP), "dofus.sounds.AudioElement::loops", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/sounds/AudioElement.as", 172);
            return;
        } // end if
        this._nLoops = nValue;
        //return (this.loops());
    ...
    _loc1.__set__offset = function (nValue)
    {
        ...
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.ValueOutOfRangeException(this, "AudioElement", "set offset", "nValue", nValue, 0, this._nMaxLength == null ? (Number.POSITIVE_INFINITY) : (this._nMaxLength)), "dofus.sounds.AudioElement::offset", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/sounds/AudioElement.as", 197);
            return;
        } // end if
    ...
    _loc1.__set__maxLength = function (nValue)
    {
        if (nValue < 0)
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.ValueOutOfRangeException(this, "AudioElement", "set maxLength", "nValue", nValue, 0, Number.POSITIVE_INFINITY), "dofus.sounds.AudioElement::maxLength", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/sounds/AudioElement.as", 222);
            return;
        } // end if
    ...
    _loc1.onLoad = function (bSuccess)
    {
        if (!bSuccess)
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.FileLoadException(this, "AudioElement", "onLoad", this._sFile), "dofus.sounds.AudioElement::onLoad", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/sounds/AudioElement.as", 430);
            return;
        } // end if
        this._bLoaded = true;
