    ...
    _loc1.itemSelected = function (oEvent)
    {
        ...
        if (_loc3.name != this.api.datacenter.Player.Name)
        {
            ...
            else
            {
                ...
                com.ankamagames.tools.Logger.out("showPlayerPopupMenu called from GuilMembersViewer.as:142", "dofus.graphics.gapi.controls.GuildMembersViewer::itemSelected", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/controls/GuildMembersViewer.as", 143);
            } // end if
        } // end else if
    };
