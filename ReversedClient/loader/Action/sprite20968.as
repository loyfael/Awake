...
if (!ank.gapi.controls.ScrollBar)
{
    ...
    _loc1.createChildren = function ()
    {
        ...
        _loc2.up_mc._visible = true;
        _loc2.over_mc._visible = false;
        _loc2.down_mc._visible = false;
        _loc3.up_mc._visible = true;
        _loc3.over_mc._visible = false;
        _loc3.down_mc._visible = false;
        _loc4.up_mc._visible = true;
        _loc4.over_mc._visible = false;
        _loc4.down_mc._visible = false;
        _loc5.up_mc._visible = true;
        _loc5.over_mc._visible = false;
        _loc5.down_mc._visible = false;
    ...
    _loc1.draw = function ()
    {
        ...
        ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3.up_mc.bg_mc, _loc2.sbarrowbgcolor, _loc2.sbarrowbgalpha);
        ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3.up_mc.arrow_mc, _loc2.sbarrowcolor, _loc2.sbarrowalpha);
        ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3.down_mc.bg_mc, _loc2.sbarrowbgcolor, _loc2.sbarrowbgalpha);
        ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3.down_mc.arrow_mc, _loc2.sbarrowcolor, _loc2.sbarrowalpha);
        ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3.over_mc.bg_mc, _loc2.sbarrowbgcolor, _loc2.sbarrowbgalpha);
        ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc3.over_mc.arrow_mc, _loc2.sbarrowcolor, _loc2.sbarrowalpha);
        ...
        {
            ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcHolder.thumb_mc[k], _loc2.sbthumbcolor, _loc2.sbthumbalpha);
        } // end of for...in
        ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcHolder.track_mc, _loc2.sbtrackcolor, _loc2.sbtrackalpha);
    };
    _loc1.size = function ()
    {
        super.size();
    ...
    _loc1.resizeThumb = function ()
    {
        ...
        {
            this._mcHolder.thumb_mc._height = Math.min(Math.abs(this._nPage / (this._nMax - this._nMin)), 1) * this._mcHolder.track_mc._height;
    ...
    _loc1.setScrollPropertiesToTarget = function ()
    {
        ...
        else
        {
            ...
            var _loc5 = 0.900000 * _loc3 / _loc4 * _loc2;
