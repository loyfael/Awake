...
if (!dofus.graphics.gapi.ui.AskGameBegin)
{
    ...
    _loc1.initTexts = function ()
    {
        ...
        this._lblParagraph1.text = this.api.lang.getText("POPUP_GAME_BEGINNING_PARAGRAPH1");
        this._lblParagraph2.text = this.api.lang.getText("POPUP_GAME_BEGINNING_PARAGRAPH2");
        this._lblParagraph3.text = this.api.lang.getText("POPUP_GAME_BEGINNING_PARAGRAPH3");
    };
