...
if (!ank.battlefield.MapHandler)
{
                ...
                if (_loc21.layerGroundNum != 0)
                {
                    ...
                    else
                    {
                        ...
                        else if (_loc21.layerGroundRot != 0)
                        {
                            ...
                            {
                                _loc25._yscale = 192.860000;
                                _loc25._xscale = 51.850000;
                            } // end if
                        } // end else if
                ...
                if (_loc21.layerObject1Num != 0)
                {
                    ...
                    else
                    {
                        ...
                        if (_loc21.groundSlope == 1 && _loc21.layerObject1Rot != 0)
                        {
                            ...
                            {
                                _loc27._yscale = 192.860000;
                                _loc27._xscale = 51.850000;
                            } // end if
                        } // end if
    ...
    _loc1.updateCell = function (nCellNum, oNewCell, sMaskHex, nPermanentLevel)
    {
        ...
        if (nCellNum == 65)
        {
            com.ankamagames.tools.Logger.out("[wtf]Kam Cellule 65. Mask : " + _loc6, "ank.battlefield.MapHandler::updateCell", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/battlefield/MapHandler.as", 608);
        } // end if
    ...
    _loc1.setObject2Frame = function (nCellNum, frame, hide)
    {
        ...
        if (ank.battlefield.Constants.USE_STREAMING_FILES && (ank.battlefield.Constants.STREAMING_METHOD == "explod" && !_loc6.fullLoaded))
        {
        ...
        else if (ank.battlefield.Constants.USE_STREAMING_FILES && ank.battlefield.Constants.STREAMING_METHOD == "explod")
        {
            for (var s in _loc6)
            {
                ...
                {
                    _loc6[s].gotoAndStop(frame);
                } // end if
            } // end of for...in
        }
        else
        {
            _loc6.gotoAndStop(frame);
        } // end else if
    };
    ...
    _loc1.getCellHeight = function (nCellNum)
    {
        ...
        var _loc4 = _loc3.groundSlope == undefined || _loc3.groundSlope == 1 ? (0) : (0.500000);
    ...
    _loc1.resetEmptyCells = function ()
    {
        ...
        if (_loc5 > 0)
        {
            com.ankamagames.tools.Logger.out("[resetEmptyCells] " + _loc5 + " dead cells cleaned...", "ank.battlefield.MapHandler::resetEmptyCells", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/battlefield/MapHandler.as", 878);
        } // end if
    };
        ...
        switch (_loc4)
        {
            case "Ground":
            {
                ...
                if (_loc5.groundSlope == 1 && _loc5.layerGroundRot != 0)
                {
                    ...
                    if (mc._rotation % 180)
                    {
                        mc._yscale = 192.860000;
                        mc._xscale = 51.850000;
                    }
                    else
                    {
