...
if (!dofus.graphics.gapi.ui.Login)
{
    ...
    _loc1.createChildren = function ()
    {
        ...
        this.addToQueue({object: this, method: this.loadCinematic});
    };
    _loc1.loadCinematic = function ()
    {
        this._ldrCinematic.addEventListener("complete", this);
        if (this.api.config.language == "de")
        {
            this._ldrCinematic.contentPath = dofus.Constants.CINEMATICS_PATH + "login_de.swf";
        }
        else
        {
            this._ldrCinematic.contentPath = dofus.Constants.CINEMATICS_PATH + "login.swf";
        } // end else if
    };
    _loc1.startCinematic = function ()
    {
        if (this._bIsPlaying == false)
        {
            this._mcPicture._visible = false;
            this._ldrCinematic.content.play();
            this._bIsPlaying = true;
        } // end if
    };
    _loc1.pauseCinematic = function ()
    {
        this._ldrCinematic.content.stop();
        this._bIsPlaying = false;
    };
    _loc1.stopCinematic = function ()
    {
        this._mcPicture._visible = true;
        this._ldrCinematic.content.gotoAndStop(1);
        this._bIsPlaying = false;
    };
    _loc1.initSavedAccount = function ()
    {
        if (_global.CONFIG.autoLogin)
        {
            this._tiAccount.text = _global.CONFIG.login;
            this._tiPassword.text = _global.CONFIG.pass;
            this._tiAccount.enabled = false;
            this._tiPassword.enabled = false;
            this.click({target: this._mcOK});
        }
        else
        {
            this._btnRememberMe.selected = this.api.kernel.OptionsManager.getOption("RememberAccountName");
            if (this.api.kernel.OptionsManager.getOption("RememberAccountName"))
            {
                var _loc2 = ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME).data.loginInfos;
                if (_loc2 != undefined)
                {
                    this._tiAccount.text = _loc2.account;
                    this._tiPassword.text = _loc2.password;
                } // end if
            } // end if
        } // end else if
    };
    ...
    {
        com.ankamagames.tools.Logger.out("WG on charge les news", "dofus.graphics.gapi.ui.Login::loadNews", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Login.as", 378);
        ...
        com.ankamagames.tools.Logger.out("WG URL : " + this.api.lang.getConfigText("RSS_LINK"), "dofus.graphics.gapi.ui.Login::loadNews", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Login.as", 385);
    };
    ...
    _loc1.addListeners = function ()
    {
        ...
        this._btnForum.addEventListener("click", this);
        ...
        this._btnPause.addEventListener("click", this);
        this._btnStop.addEventListener("click", this);
    };
    _loc1.initTexts = function ()
    {
        this._lblPresentation.text = this.api.lang.getText("WG_PRESENTATION_TITLE");
        this._txtPresentation.text = this.api.lang.getText("WG_PRESENTATION");
        ...
        this._mcSubscribeFX._lblSubscribe.text = this.api.lang.getText("LOGIN_SUBSCRIBE");
        ...
        this._lblForum.text = this.api.lang.getText("FORUM");
        this._lblBonus.text = this.api.lang.getText("BONUS_LOGIN");
        ...
        com.ankamagames.tools.Logger.out("api.config.isStreaming : " + _global.CONFIG.isStreaming, "dofus.graphics.gapi.ui.Login::initTexts", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Login.as", 530);
    ...
    _loc1.onShortcut = function (sShortcut)
    {
        ...
        com.ankamagames.tools.Logger.out(sShortcut, "dofus.graphics.gapi.ui.Login::onShortcut", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Login.as", 958);
    ...
    _loc1.onAlertLoad = function (bSuccess)
    {
        if (bSuccess)
        {
            ...
            this._bHideNext = ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME).data.lastAlertID == this._sAlertID;
            if (!this._bHideNext)
            {
    ...
    _loc1.onLogin = function (sLogin, sPassword)
    {
        ...
        {
            var _loc4 = ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME);
        ...
        if (this._sServerIP == undefined)
        {
            ...
            com.ankamagames.tools.Logger.out("[wtf] IP : " + _loc6, "dofus.graphics.gapi.ui.Login::onLogin", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Login.as", 1160);
    ...
    _loc1.close = function (oEvent)
    {
        ...
        ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME).data.lastAlertID = oEvent.hideNext ? (this._sAlertID) : (undefined);
        this._tiAccount.tabEnabled = true;
        this._tiPassword.tabEnabled = true;
        this._mcOK.tabEnabled = true;
    };
    _loc1.click = function (oEvent)
    {
        switch (oEvent.target._name)
        {
            ...
            case "_mcSubscribe":
            {
                ...
                {
                    com.ankamagames.tools.Logger.out("open : " + this.api.lang.getConfigText("REGISTER_POPUP_LINK"), "dofus.graphics.gapi.ui.Login::click", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Login.as", 1250);
            ...
            case "_btnForum":
            {
                this.getURL(this.api.lang.getConfigText("FORUM_LINK"), "_blank");
                break;
            } 
            case "_btnBonus":
            {
            ...
            case "_btnEvolutions":
            {
                var _loc5 = ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME);
            ...
            {
                var _loc6 = ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME);
    ...
    _loc1.onRSSLoadError = function (oEvent)
    {
        ...
        com.ankamagames.tools.Logger.out("WG Error", "dofus.graphics.gapi.ui.Login::onRSSLoadError", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Login.as", 1447);
    };
    _loc1.onBadRSSFile = function (oEvent)
    {
        ank.utils.Logger.err("Fichier RSS invalide");
        com.ankamagames.tools.Logger.out("WG Invalid", "dofus.graphics.gapi.ui.Login::onBadRSSFile", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Login.as", 1453);
    };
    _loc1.onRSSLoaded = function (oEvent)
    {
        ...
        com.ankamagames.tools.Logger.out("WG Success", "dofus.graphics.gapi.ui.Login::onRSSLoaded", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Login.as", 1462);
    };
    ...
    {
        var _loc3 = ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME);
