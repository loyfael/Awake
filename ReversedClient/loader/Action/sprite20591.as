...
if (!dofus.graphics.gapi.controls.BannerSpriteInfos)
{
    ...
    _loc1.initData = function ()
    {
        ...
        this._lblTackle.text = _loc2[7] == undefined ? ("0%") : (_loc2[7] + "%");
        this._lblDodgeTackle.text = _loc2[8] == undefined ? ("0%") : (_loc2[8] + "%");
    };
    _loc1.applyColor = function (mc, zone)
    {
        ...
        switch (zone)
        {
            ...
            case 4:
            {
                _loc4 = this._oSprite.color4;
                break;
            } 
            case 5:
            {
                _loc4 = this._oSprite.color5;
                break;
            } 
        } // End of switch
