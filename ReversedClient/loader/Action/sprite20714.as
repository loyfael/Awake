...
if (!dofus.sounds.AudioEvents)
{
    ...
    {
        dofus.sounds.AudioEvents.api.sounds.playEnvironment(dofus.sounds.AudioEvents.api.datacenter.Map.ambianceID);
    ...
    {
        this.getAudioManager().backToOldMusic();
    };
    ...
    _loc1.onBannerNextTurnButtonClick = function ()
    {
        if (dofus.sounds.AudioEvents.api.kernel.XTRA_LANG_FILES_LOADED)
        {
            this.getAudioManager().playEffect(dofus.sounds.AudioEvents.api.lang.getEffectFromKeyname("NEXT_TURN"));
        } // end if
    };
    _loc1.onBannerInventoryButtonClick = function ()
    {
        if (dofus.sounds.AudioEvents.api.kernel.XTRA_LANG_FILES_LOADED)
        {
            this.getAudioManager().playEffect(dofus.sounds.AudioEvents.api.lang.getEffectFromKeyname("INVENTORY"));
        } // end if
    };
    _loc1.onVersus = function ()
    {
        this.getAudioManager().playEffect(dofus.sounds.AudioEvents.api.lang.getEffectFromKeyname("VERSUS"));
    };
