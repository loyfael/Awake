...
if (!dofus.graphics.gapi.ui.Quests)
{
    ...
    _loc1.showStepViewer = function (bShow)
    {
        ...
        this._fxViewer._visible = bShow;
        this._bgViewer._visible = bShow;
    ...
    _loc1.followQuest = function (oQuest)
    {
        var _loc3 = this.api.ui.getUIComponent("PopupInfoMenu");
        if (_loc3 != undefined)
        {
            _loc3.addPopup(oQuest);
        } // end if
        return (true);
    };
