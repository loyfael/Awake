...
if (!ank.gapi.controls.ProgressBar)
{
    ...
    _loc1.draw = function ()
    {
        ...
        for (var k in _loc2)
        {
            ...
            ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2[k], _loc3[_loc4 + "color"]);
        } // end of for...in
        _loc2 = this._mcRenderer._mcBgMiddle;
        for (var k in _loc2)
        {
            var _loc5 = k.split("_")[0];
            ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2[k], _loc3[_loc5 + "color"]);
        } // end of for...in
        _loc2 = this._mcRenderer._mcBgRight;
        for (var k in _loc2)
        {
            var _loc6 = k.split("_")[0];
            ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2[k], _loc3[_loc6 + "color"]);
        } // end of for...in
        _loc2 = this._mcRenderer._mcUpLeft;
        for (var k in _loc2)
        {
            var _loc7 = k.split("_")[0];
            ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2[k], _loc3[_loc7 + "color"]);
        } // end of for...in
        _loc2 = this._mcRenderer._mcUpMiddle;
        for (var k in _loc2)
        {
            var _loc8 = k.split("_")[0];
            ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2[k], _loc3[_loc8 + "color"]);
        } // end of for...in
        _loc2 = this._mcRenderer._mcUpRight;
        for (var k in _loc2)
        {
            var _loc9 = k.split("_")[0];
            ank.gapi.core.UIBasicComponent.setMovieClipColor(_loc2[k], _loc3[_loc9 + "color"]);
        } // end of for...in
    };
