...
if (!dofus.graphics.gapi.controls.StatsViewer)
{
    ...
    {
        com.ankamagames.tools.Logger.out("fullStatsChanged!", "dofus.graphics.gapi.controls.StatsViewer::fullStatsChanged", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/controls/StatsViewer.as", 103);
        this.initData();
    };
