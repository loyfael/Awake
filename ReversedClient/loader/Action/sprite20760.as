...
if (!ank.battlefield.mc.Container)
{
    ...
    _loc1.clear = function (bForceReload)
    {
        ...
        if (this.ExternalContainer == undefined || bForceReload)
        {
            ...
            com.ankamagames.tools.Logger.out("LOAD " + this._sObjectsFile, "ank.battlefield.mc.Container::clear", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/battlefield/mc/Container.as", 89);
    ...
    _loc1.resetExternalContainer = function ()
    {
        for (var object in this.ExternalContainer)
        {
            if (typeof(this.ExternalContainer[object]) == "movieclip")
            {
                this.ExternalContainer[object].removeMovieClip();
            } // end if
        } // end of for...in
        this.ExternalContainer.removeMovieClip();
    ...
    _loc1.getZoomFactor = function (Void)
    {
        ...
        var _loc5 = 0;
        if (_loc3 == ank.battlefield.Constants.DEFAULT_MAP_WIDTH && _loc4 == ank.battlefield.Constants.DEFAULT_MAP_HEIGHT)
        {
            return (100);
        } // end if
        var _loc6 = this._mcBattlefield.screenWidth / (ank.battlefield.Constants.CELL_WIDTH * (_loc3 - 1)) * 100;
        var _loc7 = this._mcBattlefield.screenHeight / (ank.battlefield.Constants.CELL_HEIGHT * (_loc4 - 1)) * 100;
        return (Math.max(_loc6, _loc7));
        return (_loc5);
    };
