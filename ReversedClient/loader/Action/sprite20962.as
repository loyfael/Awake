...
if (!dofus.graphics.gapi.controls.Timeline)
{
    ...
    _loc1.nextTurn = function (id, bWithoutTween)
    {
        ...
        this.layout_mc.pointer_mc._y = _loc4._oData.isSummoned ? (dofus.graphics.gapi.controls.Timeline.ITEM_SUMMONED_HEIGHT_DELTA) : (dofus.graphics.gapi.controls.Timeline.ITEM_HEIGHT_DELTA);
    ...
    _loc1.updateCharacters = function ()
    {
        ...
        {
            var _loc8 = _loc3[_loc4];
            var _loc6 = _loc8.id;
            if (_loc7)
            {
                this.layout_mc.items_mc["item" + _loc6].data = _loc8;
                continue;
            } // end if
            if (_loc6 == this._currentDisplayIndex)
            {
                _loc7 = true;
            } // end if
        } // end while
    ...
    _loc1.generate = function (cs)
    {
        ...
        while (++_loc5, _loc5 < _loc6)
        {
            ...
            _loc17._x = _loc13;
            _loc17._y = _loc16.isSummoned ? (dofus.graphics.gapi.controls.Timeline.ITEM_SUMMONED_HEIGHT_DELTA) : (dofus.graphics.gapi.controls.Timeline.ITEM_HEIGHT_DELTA);
            if (!_loc16.isSummoned)
            {
                var _loc14 = _loc17;
