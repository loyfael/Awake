...
if (!dofus.aks.Infos)
{
    ...
    _loc1.sendScreenInfo = function ()
    {
        ...
        com.ankamagames.tools.Logger.out("[wtf]" + "Ir" + Stage.width + ";" + Stage.height + ";" + _loc2 + "," + Stage.displayState, "dofus.aks.Infos::sendScreenInfo", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Infos.as", 56);
    ...
    _loc1.onMessage = function (sExtraData)
    {
            ...
            switch (_loc4)
            {
                case "0":
                {
                    ...
                    if (!_global.isNaN(_loc10))
                    {
                        ...
                        switch (_loc10)
                        {
                            ...
                            case 56:
                            {
                                ...
                                _loc13 = true;
                                var _loc16 = this.api.ui.getUIComponent("PopupInfoMenu");
                                if (_loc16 != undefined)
                                {
                                    _loc16.addPopup();
                                } // end if
                            ...
                            case 73:
                            {
                                var _loc17 = new dofus.datacenter.Item(0, _loc11[1]);
                                _loc11[2] = _loc17.name;
                                break;
                            } 
                            case 82:
                            case 83:
                            ...
                            {
                                _loc6 = "MESSAGE_CHAT";
                                var _loc18 = new dofus.datacenter.Item(0, _loc11[0]);
                                var _loc19 = new Array();
                                var _loc20 = 3;
                                
                                while (++_loc20, _loc20 < _loc11.length)
                                {
                                    _loc19.push(_loc11[_loc20]);
                                } // end while
                                _loc11 = [_loc18.name, _loc11[1], this.api.lang.getText("OBJECT_CHAT_" + _loc11[2], _loc19)];
                                break;
                            } 
                            case 151:
                            {
                                _loc6 = "WHISP_CHAT";
                                var _loc21 = new dofus.datacenter.Item(0, _loc11[0]);
                                var _loc22 = new Array();
                                var _loc23 = 2;
                                
                                while (++_loc23, _loc23 < _loc11.length)
                                {
                                    _loc22.push(_loc11[_loc23]);
                                } // end while
                                _loc11 = [_loc21.name, this.api.lang.getText("OBJECT_CHAT_" + _loc11[1], _loc22)];
                                break;
                            } 
                        } // End of switch
                        if (_loc14)
                    ...
                    if (_loc12 != undefined)
                    {
                        ...
                        if (_loc13)
                        {
                            var _loc24 = this.api.ui.getUIComponent("Notification");
                            if (_loc24 != undefined)
                            {
                                _loc24.addNotification(_loc12);
                            } // end if
                        } // end if
                    } // end if
                    break;
                ...
                case "1":
                {
                    ...
                    if (!_global.isNaN(_loc10))
                    {
                        ...
                        var _loc25 = this.api.lang.getText("ERROR_" + _loc26, _loc11);
                    }
                    else
                    {
                        _loc25 = this.api.lang.getText(_loc9, _loc11);
                    } // end else if
                    if (_loc25 != undefined)
                    {
                        _loc3.push(_loc25);
                ...
                case "2":
                {
                    ...
                    if (!_global.isNaN(_loc10))
                    {
                        ...
                        var _loc27 = this.api.lang.getText("PVP_" + _loc10, _loc11);
                    }
                    else
                    {
                        _loc27 = this.api.lang.getText(_loc9, _loc11);
                    } // end else if
                    if (_loc27 != undefined)
                    {
                        _loc3.push(_loc27);
        ...
        var _loc28 = _loc3.join(" ");
        if (_loc28 != "")
        {
            this.api.kernel.showMessage(undefined, _loc28, _loc6);
        } // end if
    };
