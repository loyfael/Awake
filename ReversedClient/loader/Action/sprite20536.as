...
if (!dofus.utils.criterions.CriterionManager)
{
    ...
    }).parseCriterion = function (sCriterion)
    {
        ...
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.NullPointerException(dofus.utils.criterions.CriterionManager, "CriterionManager", "parseCriterion", "criterionToReturn"), "dofus.utils.criterions.CriterionManager::parseCriterion", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/utils/criterions/CriterionManager.as", 73);
            return (null);
        } // end if
        return (_loc7);
    };
