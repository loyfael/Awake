...
if (!dofus.managers.DebugManager)
{
    ...
    _loc1.print = function (sMsg, nLevel, bEvenIfOff)
    {
        ...
        com.ankamagames.tools.Logger.out("[" + _loc6 + "] " + _loc5, "dofus.managers.DebugManager::print", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/DebugManager.as", 96);
