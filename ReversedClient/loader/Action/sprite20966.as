...
if (!dofus.utils.LangFileLoader)
{
    ...
    _loc1.loadWithNextURL = function ()
    {
        ...
        if (this._urlIndex < this._aServers.length && this._aServers.length > 0)
        {
            ...
            com.ankamagames.tools.Logger.out("[wtf] -> Chargement de " + _loc3, "dofus.utils.LangFileLoader::loadWithNextURL", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/utils/LangFileLoader.as", 91);
    ...
    _loc1.processFile = function ()
    {
        ...
        com.ankamagames.tools.Logger.out("[wtf]Flush des données", "dofus.utils.LangFileLoader::processFile", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/utils/LangFileLoader.as", 249);
        if (this._so.flush() == false)
        {
