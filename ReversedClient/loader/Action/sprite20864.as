    ...
    _loc1.href = function (oEvent)
    {
        ...
        switch (_loc3[0])
        {
            case "ShowPlayerPopupMenu":
            {
                ...
                com.ankamagames.tools.Logger.out("showPlayerPopupMenu called from Debug.as:326", "dofus.graphics.gapi.ui.Debug::href", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Debug.as", 327);
                break;
            } 
            case "ExecCmd":
            {
