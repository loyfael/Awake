...
if (!dofus.managers.GameManager)
{
    ...
    _loc1.askAttack = function (sSpriteID)
    {
        ...
        com.ankamagames.tools.Logger.out("SHOW_PVP_GAIN_WARNING_POPUP : " + this.api.lang.getConfigText("SHOW_PVP_GAIN_WARNING_POPUP") + " (" + _loc3.pvpGain + ")", "dofus.managers.GameManager::askAttack", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/GameManager.as", 194);
    ...
    _loc1.useRessourceFromHere = function (nCellNum, nSkillID)
    {
    ...
    _loc1.useRessource = function (mcCell, nCellNum, nSkillID)
    {
        ...
        {
            this.useRessourceFromHere(nCellNum, nSkillID);
        } // end if
    };
    ...
    _loc1.cleanPlayer = function (sSpriteID)
    {
        if (sSpriteID != this.api.datacenter.Game.currentPlayerID)
        {
            ...
            this.api.gfx.addCountdownOverHead(_loc3);
        } // end if
    };
    ...
    _loc1.terminateFight = function ()
    {
        ...
        {
            ank.utils.Timer.setTimer(this, "game", this.api.kernel.GameManager, this.api.kernel.GameManager.cleanAndLeave, 2000);
        } // end else if
    };
    _loc1.cleanAndLeave = function ()
    {
    ...
    _loc1.switchToSpellLaunch = function (oSpell, bSpell, bForced)
    {
        ...
        com.ankamagames.tools.Logger.out("WG Cursor forbidden par défaut", "dofus.managers.GameManager::switchToSpellLaunch", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/GameManager.as", 519);
    ...
    {
        if (dofus.Constants.WG_DISABLE_COMPASS)
        {
            return (false);
        } // end if
    ...
    _loc1.showPlayerPopupMenu = function (oSpriteData, sPlayerName, oPartyItem, bNoFriendsInvite, bNoGuildInvite, sUniqId, bShowJoinFriend)
    {
        ...
        var _loc13 = _loc9.id;
        if (_loc13 == this.api.datacenter.Player.ID && (oPartyItem == undefined && dofus.Constants.WG))
        {
            return;
        } // end if
        ...
        else
        {
            ...
            if (_loc13 == this.api.datacenter.Player.ID)
            {
                ...
                if (!dofus.Constants.WG && (!_loc12 && this.api.datacenter.Player.canBeMerchant))
                {
                ...
                else if (!dofus.Constants.WG && !_loc12)
                {
            ...
            else
            {
                ...
                {
                    com.ankamagames.tools.Logger.out(this.api.datacenter.Basics.aks_current_server.id, "dofus.managers.GameManager::showPlayerPopupMenu", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/GameManager.as", 1219);
                    var _loc18 = false;
                    var _loc19 = 0;
                ...
                if (!_loc12 || _loc12 && sPlayerName != undefined)
                {
                    ...
                    if (!dofus.Constants.WG && bNoFriendsInvite != true)
                    {
                    ...
                    com.ankamagames.tools.Logger.out("WG Le player " + this.api.datacenter.Player.Name + " a showJoinFriend a " + bShowJoinFriend, "dofus.managers.GameManager::showPlayerPopupMenu", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/GameManager.as", 1273);
                    if (bShowJoinFriend)
                    {
                        if (this.api.datacenter.Player.isAuthorized)
                        {
                            com.ankamagames.tools.Logger.out("WG Le player " + this.api.datacenter.Player.Name + " est admin", "dofus.managers.GameManager::showPlayerPopupMenu", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/GameManager.as", 1278);
                            _loc15.addItem(this.api.lang.getText("JOIN_ADMIN"), this.api.kernel.AdminManager, this.api.kernel.AdminManager.sendCommand, ["join " + _loc14]);
                        } // end if
                        if (this.api.datacenter.Map.area == 11)
                        {
                            _loc15.addItem(this.api.lang.getText("JOIN_SMALL"), this.api.network.Friends, this.api.network.Friends.joinFriend, [_loc14]);
                        } // end if
                        com.ankamagames.tools.Logger.out("WG Le player " + this.api.datacenter.Player.Name + " est dans la zone  " + this.api.datacenter.Map.superarea + " : " + this.api.datacenter.Map.area, "dofus.managers.GameManager::showPlayerPopupMenu", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/GameManager.as", 1285);
                    } // end if
                } // end if
            ...
            if (!dofus.Constants.WG && (_loc9 != null && (_loc9.isVisible && (this.api.ui.getUIComponent("Zoom") == undefined && !_loc12))))
            {
    ...
    _loc1.getCriticalHitChance = function (nDice)
    {
        ...
        if (_loc4 != 0)
        {
            nDice = Math.min(nDice, Number(nDice * (Math.E * 1.100000 / Math.log(_loc4 + 12))));
        } // end if
