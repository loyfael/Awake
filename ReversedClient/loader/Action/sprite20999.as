...
// [Initial MovieClip Action of sprite 20999]
#initclip 8
if (!ank.gapi.controls.Button)
{
    ...
    _loc1.__set__selected = function (bSelected)
    {
        ...
        {
            this._lblLabel._x = this._lblLabel._x + (bSelected ? (0.500000) : (-0.500000));
            this._lblLabel._y = this._lblLabel._y + (bSelected ? (0.500000) : (-0.500000));
            this._mcIcon._x = this._mcIcon._x + (bSelected ? (0.500000) : (-0.500000));
            this._mcIcon._y = this._mcIcon._y + (bSelected ? (0.500000) : (-0.500000));
    ...
    _loc1.setEnabled = function ()
    {
        ...
        {
            ank.gapi.core.UIBasicComponent.setMovieClipTransform(this, {ra: 100, rb: 0, ga: 100, gb: 0, ba: 100, bb: 0});
        } // end else if
    };
