...
if (!dofus.DofusLoader)
{
    ...
    _loc1.initTexts = function ()
    {
        ...
        this.LANG_TEXT.STARTING = {fr: "Initialisation de Wakfu les Gardiens...", en: "Initializing Wakfu les Gardiens...", es: "Inicializando Wakfu les Gardiens...", de: "Initialisierung von Wakfu les Gardiens im Gange...", pt: "Inicializando Wakfu les Gardiens...", nl: "Wakfu les Gardiens initialiseren...", it: "Inizializzazione Wakfu les Gardiens..."};
        ...
        _loc2.fr = "Vous ne pouvez pas lancer plus de clients Wakfu les Gardiens sur cet ordinateur.";
        _loc2.en = "You can\'t start anymore Wakfu les Gardiens client on this computer.";
        _loc2.es = "No puedes abrir más clientes Wakfu les Gardiens en este ordenador.";
        _loc2.de = "Es kann kein weiterer Wakfu les Gardiens-Client auf diesem Computer gestartet werden.";
        _loc2.pt = "Você não pode começar o cliente de Wakfu les Gardiens de novo neste computador.";
        _loc2.nl = "Je kan de Wakfu les Gardiens client niet meer op deze computer opstarten.";
        _loc2.it = "Non puoi lanciare più client su questo computer.";
        _loc2.linkfr = "http://www.wakfu.com";
        _loc2.linken = "http://www.wakfu.com";
        _loc2.linkes = "http://www.wakfu.com";
        _loc2.linkde = "http://www.wakfu.com";
        _loc2.linkpt = "http://www.wakfu.com";
        _loc2 = new Object();
        ...
        _loc2.fr = "Les paramètres de sécurité actuels du lecteur Flash ne permettent pas à Wakfu les Gardiens de s\'executer.";
        _loc2.en = "You must configure Wakfu les Gardiens as a trusted application on the Flash Player security settings.";
        _loc2.es = "Los parámetros de seguridad actuales del reproductor Flash no permiten la ejecución de Wakfu les Gardiens.";
        _loc2.de = "Wakfu les Gardiens muss als vertrauenswürdige Anwendung in den Sicherheitseinstellungen des Flash Players konfiguriert werden.";
        _loc2.pt = "Você deve configurar Wakfu les Gardiens como uma aplicação confiável nas configurações de segurança do Flash Player.";
        _loc2.nl = "Je zult Wakfu les Gardiens als een veilige aplicatie moeten instellen bij de beveiligings instellingen van je Flash Player.";
        _loc2.it = "I parametri di sicurezza attuali del lettore Flash non permettono l\'esecuzione di Wakfu les Gardiens.";
    ...
    _loc1.setProgressBarValue = function (nValue, nMax)
    {
        ...
        this._mcProgressBarGroup.mcProgressBar._width = nValue / 100 * nMax;
    ...
    _loc1.setTotalBarValue = function (nValue, nMax)
    {
        ...
        this._mcTotalProgressBarGroup.mcProgressBar._width = nValue / 100 * nMax;
        this._mcTotalProgressBarGroup.mcBlurredProgressBar._width = nValue / 100 * nMax;
        this._mcTotalProgressBarGroup.txtPercent.text = Math.floor(Number(this._mcTotalProgressBarGroup.mcProgressBar._width / dofus.DofusLoader.PROGRESS_BAR_SIZE) * 100) + "%";
    };
    ...
    {
        com.ankamagames.tools.Logger.out("Non critical error : " + sError, "dofus.DofusLoader::nonCriticalError", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 731);
    ...
    _loc1.showBanner = function (bShow)
    {
        ...
        if (_loc3)
        {
            ...
            com.ankamagames.tools.Logger.out("[showBanner] Show", "dofus.DofusLoader::showBanner", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 809);
            var _loc5 = "";
        ...
        else
        {
            ...
            com.ankamagames.tools.Logger.out("[showBanner] Hide", "dofus.DofusLoader::showBanner", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 830);
    ...
    _loc1.copyAndOrganizeDataServerList = function ()
    {
        ...
        com.ankamagames.tools.Logger.out("LIST", "dofus.DofusLoader::copyAndOrganizeDataServerList", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 863);
        var _loc6 = 0;
        
        while (++_loc6, _loc6 < _loc2.length)
        {
            com.ankamagames.tools.Logger.out(_loc2[_loc6].priority + " : " + _loc2[_loc6].url, "dofus.DofusLoader::copyAndOrganizeDataServerList", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 866);
        } // end while
        return (_loc2);
    };
    ...
    {
        com.ankamagames.tools.Logger.out("Loader reboot()", "dofus.DofusLoader::reboot", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 1060);
        var _loc2 = 0;
    ...
    {
        com.ankamagames.tools.Logger.out("Loader clearCache()", "dofus.DofusLoader::clearCache", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 1074);
    ...
    _loc1.onConfigLoaded = function (bSuccess, xDoc)
    {
        ...
        if (bSuccess)
        {
            this.setTotalBarValue(50, dofus.DofusLoader.PROGRESS_BAR_SIZE);
            ...
            while (_loc4 != null)
            {
                switch (_loc4.nodeName)
                {
                    ...
                    case "autologin":
                    {
                        _global.CONFIG.autoLogin = true;
                        _global.CONFIG.login = _loc4.attributes.login;
                        _global.CONFIG.pass = _loc4.attributes.pass;
                    } 
                    case "conf":
                    {
                        var attrName = _loc4.attributes.name;
                        var attrType = _loc4.attributes.type;
                        if (attrName != undefined && (dofus.Constants.TEST != true && attrType != "test" || dofus.Constants.TEST == true && attrType == "test"))
                        {
                            ...
                            for (var currentChild = _loc4.firstChild; currentChild != null; currentChild = currentChild.nextSibling)
                            {
                                switch (currentChild.nodeName)
                                {
                                    case "dataserver":
                                    {
                                        var _loc11 = currentChild.attributes.url;
                                        var _loc12 = currentChild.attributes.type;
                                        var _loc13 = Number(currentChild.attributes.priority);
                                    ...
                                    case "connserver":
                                    {
                                        var _loc14 = currentChild.attributes.name;
                                        var _loc15 = currentChild.attributes.ip;
                                        var _loc16 = currentChild.attributes.port;
    ...
    _loc1.onCheckLanguage = function (bSuccess, lv, sServer, sFiles)
    {
        ...
        {
            this.setTotalBarValue(100, dofus.DofusLoader.PROGRESS_BAR_SIZE);
            ...
            {
                var _loc8 = _loc6[2];
                com.ankamagames.tools.Logger.out(">>>>> " + _loc8, "dofus.DofusLoader::onCheckLanguage", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 1650);
    ...
    {
        if (dofus.Constants.USE_JS_LOG && _global.CONFIG.isStreaming)
        {
    ...
    _loc1.checkLocalFileListWithNextHost = function (sFiles)
    {
        ...
        {
            com.ankamagames.tools.Logger.out("Chargement du fichier de version depuis " + sURL, "dofus.DofusLoader::checkLocalFileListWithNextHost", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 1841);
            loader.loadLanguage();
            loader._bLocalFileListLoaded = true;
        };
        _loc4.onLoadError = function (mc)
        {
            com.ankamagames.tools.Logger.out("Error on load " + sURL, "dofus.DofusLoader::checkLocalFileListWithNextHost", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 1847);
    ...
    _loc1.updateNextXtra = function ()
    {
        ...
        else
        {
            ...
            {
                this.setTotalBarValue(10 + (90 - 90 / this._nTotalFile * (this._aXtraList.length - 1)), dofus.DofusLoader.PROGRESS_BAR_SIZE);
                ...
                if (this._aXtraList.length > 0 && this._aCurrentXtra[2])
                {
                    ...
                    {
                        com.ankamagames.tools.Logger.out("[        ] " + _loc2, "dofus.DofusLoader::updateNextXtra", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 1966);
                        continue;
                    } // end if
                    com.ankamagames.tools.Logger.out(_loc2 + ", locale : " + this._oXtraCurrentVersion[_loc2] + " , distant : " + _loc4, "dofus.DofusLoader::updateNextXtra", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 1970);
                    if (this._bLocalFileListLoaded)
                    {
                        if (this._bSkipDistantLoad)
                        {
                            ...
                            {
                                com.ankamagames.tools.Logger.out("[localDL ] " + _loc2, "dofus.DofusLoader::updateNextXtra", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 1980);
                                _loc4 = this._mcLocalFileList.VERSIONS[_global.CONFIG.language][_loc2];
                            }
                            else
                            {
                                com.ankamagames.tools.Logger.out("[        ] " + _loc2, "dofus.DofusLoader::updateNextXtra", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 1985);
                                continue;
                            } // end else if
                        }
                        else
                        {
                            com.ankamagames.tools.Logger.out("[serverDL] " + _loc2, "dofus.DofusLoader::updateNextXtra", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 1989);
                        } // end else if
                    }
                    else if (this._bSkipDistantLoad)
                    {
                        com.ankamagames.tools.Logger.out("erreur fatale", "dofus.DofusLoader::updateNextXtra", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 1996);
                        return;
                    }
                    else
                    {
                        com.ankamagames.tools.Logger.out("[serverDL] " + _loc2, "dofus.DofusLoader::updateNextXtra", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 2000);
                    } // end else if
                    this._bUpdate = true;
    ...
    {
        this.showWaitBar(false);
        this.setProgressBarValue(0, dofus.DofusLoader.PROGRESS_BAR_SIZE);
    };
    ...
    _loc1.onAllLoadFailed = function (mc)
    {
        ...
        switch (this._sStep)
        {
            ...
            case "XTRA":
            {
                com.ankamagames.tools.Logger.out("## Passage en chargement local", "dofus.DofusLoader::onAllLoadFailed", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/DofusLoader.as", 2300);
