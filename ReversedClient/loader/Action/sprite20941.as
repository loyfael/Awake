...
if (!ank.gapi.controls.ComboBox)
{
    ...
    _loc1.setEnabled = function ()
    {
        ...
        if (!this._bEnabled)
        {
            ank.gapi.core.UIBasicComponent.setMovieClipTransform(this, this.getStyle().disabledtransform);
        }
        else
        {
            ank.gapi.core.UIBasicComponent.setMovieClipTransform(this, {ra: 100, rb: 0, ga: 100, gb: 0, ba: 100, bb: 0, aa: 100, ab: 0});
        } // end else if
    };
    ...
    _loc1.drawList = function ()
    {
        ...
        var _loc5 = 0;
        if (this._name == "_cbDefaultQuality" && dofus.utils.Api.getInstance().datacenter.Player.Name != undefined)
        {
            _loc5 = 50;
        } // end if
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcComboBoxPopup, this._nListX, this._nListY + _loc5, this._nListWidth, this._nListHeight, 0, this.getStyle().listbordercolor);
        this._mcComboBoxPopup.attachMovie("List", "_lstCombo", this._mcComboBoxPopup.getNextHighestDepth(), {styleName: this.getStyle().liststyle, rowHeight: this._nRowHeight, _x: this._nListX + 1, _y: this._nListY + _loc5, _width: this._nListWidth - 2, _height: this._nListHeight - 1, dataProvider: this._eaDataProvider, selectedIndex: this._nSelectedIndex, cellRenderer: this._sCellRenderer});
