...
if (!dofus.graphics.gapi.ui.DocumentBook)
{
    ...
    _loc1.layoutContent = function (oPage, bLeft)
    {
        ...
        switch (oPage.type)
        {
            case "title":
            {
                this.attachMovie("BookPageTitle", _loc4, this.getNextHighestDepth(), {_x: _loc5._x, _y: _loc5._y, _width: _loc5._width, _height: _loc5._height, page: oPage});
                break;
            } 
            case "index":
            {
                this.attachMovie("BookPageIndex", _loc4, this.getNextHighestDepth(), {_x: _loc5._x, _y: _loc5._y, _width: _loc5._width, _height: _loc5._height, page: oPage});
                this[_loc4].addEventListener("chapterChange", this);
                break;
            } 
            case "text":
            {
                this.attachMovie("BookPageText", _loc4, this.getNextHighestDepth(), {_x: _loc5._x, _y: _loc5._y, _width: _loc5._width, _height: _loc5._height, page: oPage});
                break;
            } 
            case "blank":
            default:
