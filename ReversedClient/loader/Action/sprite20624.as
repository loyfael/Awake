...
if (!dofus.graphics.gapi.ui.Spells)
{
    ...
    _loc1.init = function ()
    {
        com.ankamagames.tools.Logger.out("WG Spell : init", "dofus.graphics.gapi.ui.Spells::init", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Spells.as", 63);
        super.init(false, dofus.graphics.gapi.ui.Spells.CLASS_NAME);
        this.gapi.getUIComponent("Banner").shortcuts.setCurrentTab(dofus.graphics.gapi.controls.MouseShortcuts.TAB_SPELLS);
    };
    ...
    {
        com.ankamagames.tools.Logger.out("WG Spell : createChildren", "dofus.graphics.gapi.ui.Spells::createChildren", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Spells.as", 90);
        this._nSelectedSpellType = -2;
    ...
    _loc1.addListeners = function ()
    {
        ...
        this._dgSpells.addEventListener("itemDrop", this);
    ...
    {
        com.ankamagames.tools.Logger.out("WG Spell : initData", "dofus.graphics.gapi.ui.Spells::initData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Spells.as", 137);
        this.updateBonus();
    };
    _loc1.initTexts = function ()
    {
        com.ankamagames.tools.Logger.out("WG Spell : initTexts", "dofus.graphics.gapi.ui.Spells::initTexts", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Spells.as", 144);
    ...
    _loc1.updateSpells = function ()
    {
        ...
        {
            var _loc4 = _loc2[k];
            if (_loc4.classID != -1 && (_loc4.classID == 0 || _loc4.classID == 10))
            {
                _loc3.push(_loc4);
            } // end if
        } // end of for...in
    ...
    _loc1.showDetails = function (bShow)
    {
        ...
        if (bShow)
        {
            com.ankamagames.tools.Logger.out("WG : Spell : showDetails", "dofus.graphics.gapi.ui.Spells::showDetails", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/Spells.as", 256);
    ...
    {
        if (oEvent.row.item != undefined && oEvent.row.item.level < oEvent.row.item.maxLevel)
        {
            this.hideSpellBoostViewer(false, oEvent.row.item);
        } // end if
    };
