...
if (!dofus.aks.Items)
{
    ...
    {
        com.ankamagames.tools.Logger.out("WG OnAccessories " + sExtraData, "dofus.aks.Items::onAccessories", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Items.as", 83);
        ...
        while (++_loc7, _loc7 < _loc5.length)
        {
            ...
            {
                com.ankamagames.tools.Logger.out("WG On ajoute l\'accesory " + _loc8 + " au joueur " + _loc4 + " à l\'emplacement " + _loc7, "dofus.aks.Items::onAccessories", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/aks/Items.as", 117);
                ...
                switch (_loc7)
                {
                    case 3:
                    {
                        var _loc13 = new dofus.datacenter.Accessory(_loc6[3].unicId, 100, undefined);
                        var _loc14 = new dofus.datacenter.Accessory(_loc6[3].unicId, 101, undefined);
                        var _loc15 = new dofus.datacenter.Accessory(_loc6[3].unicId, 102, undefined);
                        var _loc16 = new dofus.datacenter.Accessory(_loc6[3].unicId, 103, undefined);
                        var _loc17 = new dofus.datacenter.Accessory(_loc6[3].unicId, 104, undefined);
                        var _loc18 = new dofus.datacenter.Accessory(_loc6[3].unicId, 105, undefined);
                    ...
                    case 4:
                    {
                        var _loc19 = new dofus.datacenter.Accessory(_loc6[4].unicId, 106, undefined);
                        var _loc20 = new dofus.datacenter.Accessory(_loc6[4].unicId, 107, undefined);
                        var _loc21 = new dofus.datacenter.Accessory(_loc6[4].unicId, 108, undefined);
                        var _loc22 = new dofus.datacenter.Accessory(_loc6[4].unicId, 109, undefined);
                        var _loc23 = new dofus.datacenter.Accessory(_loc6[4].unicId, 110, undefined);
                        _loc19.gfxID = _loc6[4].gfxID;
                        _loc20.gfxID = _loc6[4].gfxID;
                        _loc21.gfxID = _loc6[4].gfxID;
                        _loc22.gfxID = _loc6[4].gfxID;
                        _loc23.gfxID = _loc6[4].gfxID;
                        _loc6[16] = _loc19;
                        _loc6[17] = _loc20;
                        _loc6[18] = _loc21;
                        _loc6[19] = _loc22;
                    ...
                    case 5:
                    {
                        var _loc24 = new dofus.datacenter.Accessory(_loc6[5].unicId, 99, undefined);
                        _loc24.gfxID = _loc6[5].gfxID;
                        _loc6[9] = _loc24;
                    } 
                    default:
                    {
        ...
        {
            var _loc25 = new dofus.datacenter.Accessory(_loc6[1].unicId, 17, undefined);
            _loc25.gfxID = _loc6[1].gfxID;
            _loc6[2] = _loc25;
        } // end if
        var _loc26 = this.api.datacenter.Sprites.getItemAt(_loc4);
        _loc26.accessories = _loc6;
