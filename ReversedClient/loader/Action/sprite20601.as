...
if (!ank.battlefield.LoadManager)
{
    ...
    _loc1.processLoad = function ()
    {
        ...
        while (++_loc2, _loc2 < ank.battlefield.LoadManager._aMovieClipLoader.length)
        {
            ...
            {
                com.ankamagames.tools.Logger.out("processLoad " + ank.battlefield.LoadManager._aMovieClipLoader[_loc2].file, "ank.battlefield.LoadManager::processLoad", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/battlefield/LoadManager.as", 49);
    ...
    _loc1.loadFile = function (sFile)
    {
        ...
        else
        {
            ...
            com.ankamagames.tools.Logger.out("Load : " + sFile, "ank.battlefield.LoadManager::loadFile", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/battlefield/LoadManager.as", 122);
    ...
    _loc1.onLoadError = function (mc)
    {
        ...
        com.ankamagames.tools.Logger.out("onLoadError " + _loc3.file, "ank.battlefield.LoadManager::onLoadError", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/battlefield/LoadManager.as", 241);
