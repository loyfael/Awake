...
if (!ank.gapi.controls.Container)
{
    ...
    _loc1.createChildren = function ()
    {
        ...
        ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcInteraction, 0, 0, 1, 1, 0, 0, 0);
    ...
    _loc1.setLabel = function (sLabel)
    {
        if (this._bShowLabel)
        {
            ...
            if (_loc3 > 2 && _loc4 != 0)
            {
                ank.gapi.core.UIBasicComponent.drawRoundRect(this._mcLabelBackground, 2, 2, _loc3, _loc4 + 2, 0, 0, 50);
            } // end if
        }
        else
        {
