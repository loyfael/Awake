...
if (!ank.battlefield.VisualEffectHandler)
{
    ...
    {
        com.ankamagames.tools.Logger.out("WG VisualEffectHandler.as:122 onLoadComplete called", "ank.battlefield.VisualEffectHandler::onLoadComplete", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/battlefield/VisualEffectHandler.as", 122);
        ...
        switch (displayType)
        {
            ...
            case 31:
            {
                ...
                mc._y = _loc12.y - 10;
                mc.level = _loc6;
                var _loc18 = displayType == 31 || displayType == 33 ? (0.900000) : (0.500000);
                var speed = displayType == 31 || displayType == 33 ? (0.400000) : (0.500000);
