...
if (!dofus.graphics.gapi.ui.FightsInfos)
{
    ...
    _loc1.createChildren = function ()
    {
        ...
        ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcSquare1, dofus.Constants.TEAMS_COLOR[0]);
        ank.gapi.core.UIBasicComponent.setMovieClipColor(this._mcSquare2, dofus.Constants.TEAMS_COLOR[1]);
    };
    ...
    _loc1.itemSelected = function (oEvent)
    {
        switch (oEvent.target._name)
        {
            ...
            default:
            {
                com.ankamagames.tools.Logger.out(oEvent.row, "dofus.graphics.gapi.ui.FightsInfos::itemSelected", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/FightsInfos.as", 241);
                if (oEvent.row.item.type == "player")
                {
                    this.api.kernel.GameManager.showPlayerPopupMenu(undefined, oEvent.row.item.name);
                    com.ankamagames.tools.Logger.out("showPlayerPopupMenu called from FightsInfos.as:244", "dofus.graphics.gapi.ui.FightsInfos::itemSelected", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/ui/FightsInfos.as", 245);
                } // end if
                break;
            } 
        } // End of switch
