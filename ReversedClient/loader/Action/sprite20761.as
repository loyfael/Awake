...
if (!dofus.graphics.gapi.controls.Emblem)
{
    ...
    {
        ank.gapi.core.UIBasicComponent.setMovieClipColor(this._ldrEmblemBack.content.back, this._nBackColor);
    };
    _loc1.applyUpColor = function ()
    {
        ank.gapi.core.UIBasicComponent.setMovieClipColor(this._ldrEmblemUp.content, this._nUpColor);
    };
