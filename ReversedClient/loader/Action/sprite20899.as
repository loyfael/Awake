...
if (!dofus.graphics.gapi.ui.Craft)
{
    ...
    _loc1.createChildren = function ()
    {
        ...
        _loc2._x = this._mcPlacer._x;
        _loc2._y = this._mcPlacer._y;
        this.api.network.send("wCG" + this._nSkillId, true);
    };
    ...
    _loc1.itemSelected = function (oEvent)
    {
        switch (oEvent.target._name)
        {
            ...
            default:
            {
                ...
                while (++_loc5, _loc5 < _loc3.items.length)
                {
                    var _loc6 = false;
                    for (var k in this._eaDataProvider)
                    {
                        var _loc7 = this._eaDataProvider[k];
                        if (_loc7.unicID == _loc3.items[_loc5].unicID && _loc7.Quantity >= _loc3.items[_loc5].Quantity)
                        {
                            _loc6 = true;
                            break;
                        } // end if
                ...
                if (_loc4)
                {
                    ...
                    while (++_loc8, _loc8 < _loc3.items.length)
                    {
                        for (var k in this._eaDataProvider)
                        {
                            var _loc9 = this._eaDataProvider[k];
                            if (_loc9.unicID == _loc3.items[_loc8].unicID && _loc9.Quantity >= _loc3.items[_loc8].Quantity)
                            {
                                this.api.network.Exchange.movementItem(true, _loc3.items[_loc8].unicID, _loc3.items[_loc8].Quantity);
                            } // end if
                        } // end of for...in
                    } // end while
                } // end if
