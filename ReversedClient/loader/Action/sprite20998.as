...
// [Initial MovieClip Action of sprite 20998]
#initclip 7
if (!ank.utils.Logger)
{
    if (!ank)
    ...
    {
        com.ankamagames.tools.Logger.out(txt, "ank.utils.Logger::log", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/utils/Logger.as", 49);
    ...
    {
        txt = "ERROR : " + txt;
        com.ankamagames.tools.Logger.out(txt, "ank.utils.Logger::err", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/utils/Logger.as", 70);
