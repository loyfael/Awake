...
if (!ank.gapi.styles.DefaultStylePackage)
{
    ...
    {
        super();
    }).Label = {font: "_sans", embedfonts: false, align: "center", size: 10, color: 16777215, bold: true, italic: false};
    (_global.ank.gapi.styles.DefaultStylePackage = function ()
    {
        super();
    }).LabelBlack = {font: "_sans", embedfonts: false, align: "center", size: 10, color: 0, bold: true, italic: false};
    (_global.ank.gapi.styles.DefaultStylePackage = function ()
    {
        super();
    }).TextInput = {font: "_sans", embedfonts: false, align: "left", size: 10, color: 0, bold: true, italic: false};
    (_global.ank.gapi.styles.DefaultStylePackage = function ()
    {
        super();
    ...
    {
        super();
    }).TextArea = {font: "Font2", embedfonts: true, align: "left", size: 10, bold: false, italic: false, scrollbarstyle: "ScrollBar"};
    (_global.ank.gapi.styles.DefaultStylePackage = function ()
    {
        super();
    ...
    {
        super();
    }).Window = {titlestyle: "Label", cornerradius: {tl: 13, tr: 13, br: 13, bl: 13}, bordercolor: 16777215, borderwidth: 3, backgroundcolor: 13421772, titlecolor: 5327420, titleheight: 22};
    (_global.ank.gapi.styles.DefaultStylePackage = function ()
    {
        super();
