...
if (!dofus.managers.TipsManager)
{
    ...
    _loc1.pointCell = function (nMapID, nCellID, nOffset)
    {
        if (this.api.datacenter.Basics.aks_current_map_id == nMapID || nMapID == -1)
        {
            ...
            if (_loc5 == undefined)
            {
                com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.NullPointerException(this, "TipsManager", "pointCell", "mcCell"), "dofus.managers.TipsManager::pointCell", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/TipsManager.as", 239);
                return;
            } // end if
        ...
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.InvalidOperationException(this, "TipsManager", "pointCell", "We are no more on the right map."), "dofus.managers.TipsManager::pointCell", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/TipsManager.as", 259);
            return;
        } // end else if
    };
    _loc1.pointSprite = function (nMapID, nGfxID)
    {
        ...
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.InvalidOperationException(this, "TipsManager", "pointCell", "We are no more on the right map."), "dofus.managers.TipsManager::pointSprite", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/TipsManager.as", 299);
            return;
        } // end else if
    };
    _loc1.pointPicto = function (nMapID, nPictoID)
    {
        ...
        {
            com.ankamagames.tools.Logger.out(new com.ankamagames.exceptions.InvalidOperationException(this, "TipsManager", "pointCell", "We are no more on the right map."), "dofus.managers.TipsManager::pointPicto", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/TipsManager.as", 330);
            return;
        } // end else if
    };
    ...
    _loc1.getTipsSharedObject = function ()
    {
        ...
        {
            this._soTips = ank.utils.SharedObjectFix.getLocal(dofus.Constants.GLOBAL_SO_TIPS_NAME);
        } // end if
        return (this._soTips);
    };
