...
if (!dofus.graphics.gapi.ui.MapExplorer)
{
    ...
    _loc1.addListeners = function ()
    {
        ...
        this._btnZoom.addEventListener("click", this);
    ...
    {
        this._mnMap.wPage = 95;
        this._mnMap.hPage = 48;
        this._btnGrid.selected = this.api.datacenter.Basics.mapExplorer_grid;
        if (this.dungeon != undefined)
        {
            this.initDungeonMap();
        }
    ...
    _loc1.initWorldMap = function ()
    {
        ...
        this._focusWorld = this._dmMap.superarea;
    ...
    _loc1.showMapSuperArea = function (nSuperAreaID)
    {
        ...
        if (this._dmMap.superarea == this._focusWorld)
        {
    ...
    _loc1.drawHintsOnCategoryLayer = function (categoryID)
    {
        ...
        while (++_loc5, _loc5 < _loc4.length)
        {
            ...
            if ((_loc6.superAreaID == this._focusWorld || dofus.graphics.gapi.ui.MapExplorer.FILTER_CONQUEST_ID == categoryID && categoryID != 5) && _loc6.y != undefined)
            {
    ...
    _loc1.setBtnZoomVisible = function ()
    {
        this._btnZoom._visible = this.api.datacenter.Map.superarea != 0;
    };
    _loc1.click = function (oEvent)
    {
        switch (oEvent.target._name)
        {
            ...
            {
                this.api.sounds.events.onBannerRoundButtonClick();
                var _loc4 = !this.api.datacenter.Basics.mapExplorer_grid;
                this.api.datacenter.Basics.mapExplorer_grid = _loc4;
                this._btnGrid.selected = _loc4;
                this._mnMap.showGrid = _loc4;
                break;
            } 
            case "_btnZoom":
            {
                if (this._focusWorld == 0)
                {
                    this._focusWorld = this._dmMap.superarea;
                }
                else
                ...
                this.showMapSuperArea(this._focusWorld);
                break;
            } 
            default:
            {
                var _loc5 = oEvent.target._name;
                var _loc6 = Number(_loc5.substr(9, _loc5.length));
                if (_loc6 != -1)
                {
                    this.showHintsCategory(_loc6, !this.api.kernel.OptionsManager.getOption("MapFilters")[_loc6]);
                    this.api.ui.getUIComponent("Banner").illustration.updateHints();
                }
                else
                {
                    var _loc7 = !this.api.datacenter.Basics.mapExplorer_grid;
                    this.api.datacenter.Basics.mapExplorer_grid = _loc7;
                    this._mnMap.showGrid = _loc7;
                } // end else if
                break;
            } 
        } // End of switch
    ...
    _loc1.over = function (oEvent)
    {
        switch (oEvent.target)
        {
            case this._mnMap:
            {
                ...
                ank.gapi.core.UIBasicComponent.setMovieClipTransform(this["_mcTriangle" + _loc3], dofus.graphics.gapi.ui.MapExplorer.OVER_TRIANGLE_TRANSFORM);
                break;
            } 
            ...
            case this._btnGrid:
            {
                this.gapi.showTooltip(this.api.lang.getText("MAP_EXPLORER_GRID"), oEvent.target, -20);
                break;
            } 
            default:
            {
    ...
    _loc1.out = function (oEvent)
    {
        switch (oEvent.target)
        {
            case this._mnMap:
            {
                ...
                {
                    ank.gapi.core.UIBasicComponent.setMovieClipTransform(this["_mcTriangle" + dofus.graphics.gapi.ui.MapExplorer.DIRECTIONS[_loc3]], dofus.graphics.gapi.ui.MapExplorer.OUT_TRIANGLE_TRANSFORM);
                } // end while
                break;
            } 
            default:
    ...
    _loc1.overMap = function (oEvent)
    {
        if (this.dungeon == undefined)
        {
            var _loc3 = this.api.kernel.AreasManager.getAreaIDFromCoordinates(oEvent.coordinates.x, oEvent.coordinates.y, this._focusWorld);
            var _loc4 = this.api.kernel.AreasManager.getSubAreaIDFromCoordinates(oEvent.coordinates.x, oEvent.coordinates.y, this._focusWorld);
            if (_loc4 != undefined && !(oEvent.coordinates.x == 0 && oEvent.coordinates.y == 0))
            {
                ...
                if (_loc6 != undefined)
                {
                    ...
                    var _loc8 = this.api.lang.getMapAreaText(_loc3).n + (_loc5.substr(0, 2) == "//" ? (" - ") : (" - " + _loc5));
                }
                else
                {
    ...
    _loc1.doubleClick = function (oEvent)
    {
        if (!this.api.datacenter.Game.isFight && this.dungeon == undefined)
        {
            ...
            {
                this.api.network.Basics.autorisedMoveCommand(_loc3, _loc4, this._focusWorld);
            } // end if
        } // end if
    };
