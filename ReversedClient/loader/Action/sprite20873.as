...
if (!dofus.graphics.gapi.ui.GuildMemberInfos)
{
    ...
    _loc1.updateData = function ()
    {
        ...
        if (_loc2.canManageRanks && !(this.api.datacenter.Player.guildInfos.playerRights.isBoss && _loc3.isBoss))
        {
    ...
    _loc1.no = function (oEvent)
    {
        ...
        while (++_loc3, _loc3 < this._cbRanks.dataProvider.length)
        {
            if (this._oMemberClone.rank == this._cbRanks.dataProvider[_loc3].id)
            {
                this._cbRanks.selectedIndex = _loc3;
            } // end if
        } // end while
    };
