...
if (!dofus.managers.StreamingDisplayManager)
{
    ...
    {
        com.ankamagames.tools.Logger.out("[wtf] Displaying advice " + id, "dofus.managers.StreamingDisplayManager::displayAdvice", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/StreamingDisplayManager.as", 57);
    ...
    {
        com.ankamagames.tools.Logger.out(getTimer() / 1000, "dofus.managers.StreamingDisplayManager::getPlayTime", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/StreamingDisplayManager.as", 94);
    ...
    _loc1.getDisplaysSharedObject = function ()
    {
        ...
        {
            this._soDisplays = ank.utils.SharedObjectFix.getLocal(dofus.Constants.GLOBAL_SO_DISPLAYS_NAME + this.api.datacenter.Player.Name);
        } // end if
