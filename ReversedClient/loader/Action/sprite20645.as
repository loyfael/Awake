...
if (!dofus.graphics.gapi.ui.StringCourse)
{
    ...
    _loc1.complete = function (oEvent)
    {
        ...
        var ref = this;
        this._ldrStringCourse.content.stringCourseColor = function (mc, z, last)
        {
            ref.applyColor(mc, z);
            if (last)
            {
        ...
        var _loc3 = oEvent.content.contentPath.split("/");
        if (_loc3[3] != "10.swf" && _loc3[3] != "11.swf")
        {
            ref._mcAnim.play();
        } // end if
    };
