...
if (!dofus.graphics.gapi.ui.AskAlertServer)
{
    ...
    _loc1.initWindowContent = function ()
    {
        ...
        ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME).onStatus = function (oEvent)
        {
        ...
        if (ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME).flush() != true)
        {
