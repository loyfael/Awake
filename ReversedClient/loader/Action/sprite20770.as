...
if (!dofus.managers.KeyManager)
{
    ...
    _loc1.initialize = function (oAPI)
    {
        ...
        this._so = ank.utils.SharedObjectFix.getLocal(this.api.datacenter.Player.login + dofus.Constants.GLOBAL_SO_SHORTCUTS_NAME);
    ...
    _loc1.loadShortcuts = function ()
    {
        ...
        this._aNoChatShortcuts = new Array();
        this._aAnyTimeShortcuts = new Array();
        com.ankamagames.tools.Logger.out("Vidage des raccourcis...", "dofus.managers.KeyManager::loadShortcuts", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/KeyManager.as", 355);
        for (var k in _loc2)
        {
        ...
        {
            com.ankamagames.tools.Logger.out("No shortcuts...", "dofus.managers.KeyManager::loadShortcuts", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/managers/KeyManager.as", 407);
