...
if (!ank.battlefield.SpriteHandler)
{
    ...
    _loc1.addSprite = function (sID, oSprite)
    {
        ...
        com.ankamagames.tools.Logger.out("WG SpriteHandler.as:121 SpriteHandler.addSprite OK", "ank.battlefield.SpriteHandler::addSprite", "E:\\My_Work\\WLG2\\WG2\\client\\AnkCommon\\classes/ank/battlefield/SpriteHandler.as", 121);
    };
    ...
    _loc1.slideSprite = function (sID, cellNum, seq, sAnimation)
    {
        ...
        if (_loc8 != undefined)
        {
            this.moveSprite(sID, _loc8, seq, false, sAnimation, false);
        } // end if
    };
    _loc1.moveSprite = function (sID, path, seq, bClearSequencer, sAnimation, bForcedRun, bForcedWalk, runLimit)
    {
        ...
        for (var _loc22 = 0; _loc22 < _loc20; ++_loc22)
        {
            ...
            if (_loc22 != 0)
            {
                ...
                if (Math.abs(_loc26 - _loc27) > 0.500000 && this._mcBattlefield.isJumpActivate)
                {
                    _loc23 = "jump";
                    _loc24 = "run";
                    _loc25 = true;
