...
if (!dofus.graphics.gapi.controls.SpellFullInfosViewer)
{
    ...
    _loc1.updateData = function ()
    {
        ...
        {
            if (this._oSpell.classID == 7)
            {
                this._btnLevel2._visible = false;
                this._btnLevel3._visible = false;
            }
            else
            {
                this._btnLevel2._visible = true;
                this._btnLevel3._visible = true;
            } // end else if
            this._ldrIcon.contentPath = this._oSpell.iconFile;
            this._winBackground.title = this._oSpell.name;
            ...
            this._lblRangeAP.text = this.api.lang.getText("ACTION_POINTS") + ": " + this._oSpell.apCost + " - " + this.api.lang.getText("ITEM_RANGE", [this._oSpell.rangeStr]);
        ...
        else if (this._winBackground.title != undefined)
        {
            this.click(this._btnClose);
        } // end else if
    };
        ...
        switch (this._sCurrentTab)
        {
            ...
            case "Creature":
            {
                ...
                if (_loc3 != undefined)
                {
                    ...
                    com.ankamagames.tools.Logger.out("[WG] SpellFullInfosViewer.updateCurrentTabInformations: " + _loc11.r, "dofus.graphics.gapi.controls.SpellFullInfosViewer::updateCurrentTabInformations", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/controls/SpellFullInfosViewer.as", 451);
