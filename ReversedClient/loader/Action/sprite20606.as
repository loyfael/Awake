...
if (!dofus.graphics.gapi.controls.InventoryViewer)
{
    ...
    _loc1.updateData = function ()
    {
        ...
        com.ankamagames.tools.Logger.out("On affiche l\'inventaire", "dofus.graphics.gapi.controls.InventoryViewer::updateData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/controls/InventoryViewer.as", 268);
        for (var k in this._eaDataProvider)
        {
            com.ankamagames.tools.Logger.out("WG On affiche l\'item " + k, "dofus.graphics.gapi.controls.InventoryViewer::updateData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/controls/InventoryViewer.as", 272);
            var _loc6 = this._eaDataProvider[k];
            com.ankamagames.tools.Logger.out("WG Item " + _loc6.ID + " type " + _loc6.type, "dofus.graphics.gapi.controls.InventoryViewer::updateData", "E:\\My_Work\\WLG2\\WG2\\client\\DofusClient\\classes/dofus/graphics/gapi/controls/InventoryViewer.as", 274);
